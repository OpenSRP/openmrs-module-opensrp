...
<script type="text/javascript">
	...
	function validation() {
		...
		if (name == null || name == "") {
			...
			dataTypeMessage += "<br>Team Name can contain [alphanumeric text,-] min 3, max 20.";
	...
	<form:form id="saveTeam" name="saveTeam" method="post"
		...
		<tr>
			...
			<td><form:input id="teamName" path="teamName" maxlength="20"
				...
				<span id="nameTip">Min 3 and max 20.Alphanumeric text,- is allowed</span></td>
		</tr>
		<tr>
			<td>Team Identifier</td>
			<td><form:input id="teamIdentfier" path="teamIdentifier" maxlength="20"
					onfocus="jQuery('#idTip').show();"
					onblur="jQuery('#idTip').hide();" /><span
				style="padding-left: 12px" id="idTip">Min 3 and max 20.All data types and [-._] are allowed</span></td>
		</tr>
		<tr>
			<td>Location</td>
