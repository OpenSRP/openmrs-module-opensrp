...
(function(global) {
...
})(this), define("../../node_modules/requirejs/require.js", function() {}), define("ziggy/EntityRelationshipLoader", [], function() {
    return {
        load: function() {
    ...
    var e;
    return typeof formDataRepositoryContext != "undefined" && (e = formDataRepositoryContext), {
        getFormInstanceByFormTypeAndId: function(e, t) {
            return null
        },
        ...
        saveFormSubmission: function(t, n, r) {
            return e.saveFormSubmission(JSON.stringify(t), JSON.stringify(n), r)
        },
    ...
    var r = function(e, t, s, o) {
            var u = e.findEntityDefinitionByType(o.type),
                a = o.from.split(".")[1],
                f = "select * from " + o.type + " where " + o.to + " = '" + t[a] + "'",
                l = JSON.parse(i(o)(f));
            return n.hasValue(l) ? !n.hasValue(u.relations) || u.relations.length === 0 ? l : (u.relations.forEach(function(t) {
                if (t.type !== s) {
                    var i = r(e, l, u.type, t);
                    n.hasValue(i) && (l[t.type] = i)
                }
            }), l) : null
        },
        i = function(n) {
    ...
    return {
        loadEntityHierarchy: function(t, i, s) {
            var o = t.findEntityDefinitionByType(i),
                u = "select * from " + i + " where id = '" + s + "'",
                a = JSON.parse(e.queryUniqueResult(u));
            if (!n.hasValue(o.relations) || o.relations.length === 0) {
                var f = {};
                return f[i] = a, f
            }
            o.relations.forEach(function(e) {
                a[e.type] = r(t, a, i, e)
            });
            var l = {};
            return l[i] = a, l
...
}), define("ziggy/FormModelMapper", ["ziggy/FormDataRepository", "ziggy/SqlQueryBuilder", "ziggy/IdFactory", "ziggy/Util", "ziggy/RelationKind", "ziggy/Entities"], function(e, t, n, r, i, s) {
    var o = function(e, t, n) {
            return r.hasValue(e) && t.contains(e) && !n.contains(e)
        },
        u = function(e, t, n, r) {
            var i = e.to.split(".")[1],
                s = t.findEntityByTypeAndId(r);
            s.createField(s.source + "." + i, s.source + "." + i, i, n, s.custom)
        },
        a = function(e, t) {
            var n = e.form.fields.filter(function(e) {
                return e.source === t.source
            })[0];
            r.hasValue(n) ? r.hasValue(n.value) || (n.value = t.value) : e.form.fields.push(t)
        },
        f = function(e, t) {
        ...
        c = function(e) {
            ...
            return r.hasValue(t) ? r.hasValue(t.value) || (t.value = n.generateIdFor(e.type)) : (t = {
                name: e.source + ".id",
                source: e.source + ".id",
                persistenceName: "id",
        ...
        p = function(t, n, r) {
            ...
            if (o(t, n, r)) {
                ...
                t.forEachField(function(e) {
                    a[e.persistenceName] = e.value
                }), e.saveEntity(t.type, a), u = t.getFieldByPersistenceName("id").value, r.add(t)
            }
            var f = t.findChildren();
            f.forEach(function(e) {
                if (e.kind === i.one_to_many.type) {
                    var t = n.findEntitiesByType(e.type);
                    t.forEach(function(t) {
                        h(t, n, r, u, e)
                    })
                } else {
                    var s = n.findEntityByType(e.type);
                    h(s, n, r, u, e)
                }
            })
        },
            ...
            e.form.fields.forEach(function(e) {
                if (e.shouldLoadValue) {
                    var n = e.source.split("."),
                        i = d(t, n);
                    r.hasValue(i) && (e.value = i)
                }
            })
        },
        g = function(e, t, n) {
            r.hasValue(e.form.sub_forms) && e.form.sub_forms.forEach(function(i) {
                var s = t.findPathToBaseEntityFromSubEntity(e.form.bind_type, i.bind_type),
                    o = d(n, s);
                o.forEach(function(e) {
                    var t = null;
                    i.fields.forEach(function(n) {
                        if (n.shouldLoadValue) {
                            var i = d(e, n.source.split(".").slice(-1));
                            r.hasValue(i) && (t = t || {}, t[n.name] = i)
                        }
                    }), r.hasValue(t) && i.instances.push(t)
                })
            })
        },
        y = function(e, t) {
            if (!r.hasValue(t)) return;
            var n = decodeURIComponent(decodeURIComponent(t)),
                i = JSON.parse(n);
            for (var s in i)
                if (i.hasOwnProperty(s)) {
                    var o = v(e.form.fields, s);
                    r.hasValue(o) && (o.value = i[s])
                }
        },
        b = function(e, t) {
            e.forEach(function(e) {
                r.hasValue(e.source) || (e.source = t + "." + e.name)
            })
        },
        w = function(e) {
            r.hasValue(e.form.sub_forms) && e.form.sub_forms.forEach(function(e) {
                b(e.fields, e.bind_type), e.instances = []
            })
        };
    return {
        mapToFormModel: function(n, i, s) {
            var o = e.getFormInstanceByFormTypeAndId(s.id, s.formName);
            if (r.hasValue(o)) {
                var u = JSON.parse(o);
                if (r.hasValue(u)) return u
            }
            if (!r.hasValue(n)) return i;
            b(i.form.fields, i.form.bind_type), w(i);
            if (!r.hasValue(s.entityId)) return i;
            var a = t.loadEntityHierarchy(n, i.form.bind_type, s.entityId);
            return m(i, a), y(i, s.fieldOverrides), g(i, n, a), i
        },
        mapToEntityAndSave: function(e, t) {
            ...
            t.form.fields.forEach(function(t) {
                var i = t.source.split("."),
                    s = i[i.length - 2],
                    o = n.findEntityByType(s);
                r.hasValue(o) || (o = e.findEntityDefinitionByType(s).createInstance(), o.source = t.source.substring(0, t.source.lastIndexOf(".")), n.add(o)), o.createField(t.name, t.source, i[i.length - 1], t.value, t.custom)
            });
            var i = s.newInstance();
            r.hasValue(t.form.sub_forms) && t.form.sub_forms.forEach(function(t) {
                t.instances.forEach(function(n) {
                    var r = e.findEntityDefinitionByType(t.bind_type).createInstance();
                    t.fields.forEach(function(e) {
                        var t = e.source.split(".");
                        r.createField(e.name, e.source, t[t.length - 1], n[e.name], e.custom)
                    }), r.source = t.bind_type, l(r, n), i.add(r)
                })
            }), f(n, t), n.addAll(i);
            var o = s.newInstance(),
                u = n.findEntityByType(t.form.bind_type);
            p(u, n, o)
        }
    }
}), define("ziggy/FormSubmissionRouter", [], function() {
    var e;
    return typeof formSubmissionRouter != "undefined" && (e = formSubmissionRouter), {
        route: function(t) {
            return e.route(t)
        }
    }
    ...
    var e = function(e) {
        ...
        }, t.createField = function(e, n, r, i, ca) {
    ...
    var t = function() {
        ...
        t.entityDefinitions = [], t.add = function(e) {
            ...
            return t.entityDefinitions.length !== 0
        }, t.findPathToBaseEntityFromSubEntity = function(n, r) {
            var i = t.findEntityDefinitionByType(r),
                s = i.findRelationByType(n);
            if (e.hasValue(s)) return [s.type, r];
            for (var o = 0; o < i.relations.length; o++) {
                var u = t.findPathToBaseEntityFromSubEntity(n, i.relations[o].type);
                if (e.hasValue(u)) return u.push(r), u
            }
            return null
        }
    };
    ...
    var e = function(e, t, n, r, i) {
        var s = this;
        s.type = e, s.kind = t, s.as = n, s.from = r, s.to = i
    };
    return {
        newInstance: function(t, n, r, i, s) {
            return new e(t, n, r, i, s)
        }
    }
}), define("ziggy/RelationDef", ["ziggy/Relation"], function(e) {
    var t = function(t, n, r, i, s) {
        var o = this;
        o.type = t, o.kind = n, o.as = r, o.from = i, o.to = s, o.createInstance = function() {
            return e.newInstance(o.type, o.kind, o.as, o.from, o.to)
        }
    };
    return {
        newInstance: function(e, n, r, i, s) {
            return new t(e, n, r, i, s)
        }
    }
}), define("ziggy/EntityRelationships", ["ziggy/EntityDef", "ziggy/EntityDefinitions", "ziggy/RelationDef", "ziggy/RelationKind", "ziggy/Util"], function(e, t, n, r, i) {
    var s = function(n, r) {
        var s = t.newInstance();
        return i.hasValue(n) && n.forEach(function(t) {
            var n = s.findEntityDefinitionByType(t.parent);
            i.hasValue(n) || s.add(e.newInstance(t.parent)), n = s.findEntityDefinitionByType(t.child), i.hasValue(n) || s.add(e.newInstance(t.child))
        }), i.hasValue(r.form.bind_type) && !i.hasValue(s.findEntityDefinitionByType(r.form.bind_type)) && s.add(e.newInstance(r.form.bind_type)), s
    };
    return {
        determineEntitiesAndRelations: function(e, t) {
            var o = s(e, t);
            return i.hasValue(e) ? (e.forEach(function(e) {
                var t = o.findEntityDefinitionByType(e.parent);
                i.hasValue(t.relations) || t.removeAllRelations(), t.addRelation(n.newInstance(e.child, e.kind, "parent", e.from, e.to));
                var s = o.findEntityDefinitionByType(e.child);
                i.hasValue(s.relations) || s.removeAllRelations(), s.addRelation(n.newInstance(e.parent, r[e.kind].inverse.type, "child", e.to, e.from))
            }), o) : o
        }
    }
}), define("FormDataController", ["ziggy/EntityRelationshipLoader", "ziggy/FormDefinitionLoader", "ziggy/FormModelMapper", "ziggy/FormDataRepository", "ziggy/FormSubmissionRouter", "ziggy/EntityRelationships", "ziggy/Util"], function(e, t, n, r, i, s, o) {
    var u = "1",
        a, f, l, c = function(n) {
            o.hasValue(a) || (a = e.load()), o.hasValue(f) || (f = t.load(n.formName)), o.hasValue(l) || (l = s.determineEntitiesAndRelations(a, f))
        },
        h = function(e, t) {
            c(e);
            if (l.hasEntityDefinitions()) {
                n.mapToEntityAndSave(l, t);
                var r = t.form.fields.filter(function(e) {
    ...
    return {
        get: function(e) {
            return c(e), n.mapToFormModel(l, f, e)
        },
        save: function(e, t) {
            typeof e != "object" && (e = JSON.parse(e)), typeof t != "object" && (t = JSON.parse(t)), e = h(e, t);
            var n = r.saveFormSubmission(e, t, t.form_data_definition_version || u);
            o.hasValue(n) && i.route(e.instanceId)
        },
        createOrUpdateEntity: function(e, t) {
            typeof e != "object" && (e = JSON.parse(e)), typeof t != "object" && (t = JSON.parse(t)), e = h(e, t), i.route(e.instanceId)
        },
...
}), require(["FormDataController"], function(e) {
    controller = e
