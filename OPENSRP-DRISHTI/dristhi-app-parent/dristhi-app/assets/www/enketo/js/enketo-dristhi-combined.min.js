...
if (function(global) {
    ...
    function newContext(e) {
        ...
        function n(e, n, i) {
            var r, o, a, s, l, u, c, d, p, h, f, g = n && n.split("/"),
                m = g,
                v = k.map,
                y = v && v["*"];
            if (e && "." === e.charAt(0) && (n ? (m = getOwn(k.pkgs, n) ? g = [n] : g.slice(0, g.length - 1), e = m.concat(e.split("/")), t(e), o = getOwn(k.pkgs, r = e[0]), e = e.join("/"), o && e === r + "/" + o.main && (e = r)) : 0 === e.indexOf("./") && (e = e.substring(2))), i && v && (g || y)) {
                for (s = e.split("/"), l = s.length; l > 0; l -= 1) {
                    ...
                    if (d) break;
                    !h && y && getOwn(y, c) && (h = getOwn(y, c), f = l)
                }!d && h && (d = h, p = f), d && (s.splice(0, p, d), e = s.join("/"))
            }
            return e
        }
        ...
        function a(e, t, i, r) {
            var a, s, l, u, c = null,
                ...
                h = !0,
                f = "";
            return e || (h = !1, e = "_@r" + (M += 1)), u = o(e), c = u[0], e = u[1], c && (c = n(c, d, r), s = getOwn(S, c)), e && (c ? f = s && s.normalize ? s.normalize(e, function(e) {
                return n(e, d, r)
        ...
        function p(e, t, n) {
            ...
            e.error ? e.emit("error", e.error) : (t[i] = !0, each(e.depMaps, function(i, r) {
                var o = i.id,
                    a = getOwn(T, o);
                !a || e.depMatched[r] || n[o] || (getOwn(t, o) ? (e.defineDep(r, S[o]), e.check()) : p(a, t, n))
            }), n[i] = !0)
        }

        function h() {
            var e, t, n, o, a = 1e3 * k.waitSeconds,
            ...
            if (!y) {
                ...
                f && each(c, function(e) {
                    p(e, {}, {})
                }), s && !o || !d || !isBrowser && !isWebWorker || _ || (_ = setTimeout(function() {
                    _ = 0, h()
                }, 50)), y = !1
            }
        }
        ...
        return x = {
            ...
            module: function(e) {
                return e.module ? e.module : e.module = {
                    ...
                    uri: e.map.url,
                    config: function() {
                        var t, n = getOwn(k.pkgs, e.map.id);
                        return t = n ? getOwn(k.config, e.map.id + "/" + n.main) : getOwn(k.config, e.map.id), t || {}
                    },
                    exports: S[e.map.id]
                }
            }
        }, b = function(e) {
            this.events = getOwn(D, e.id) || {}, this.map = e, this.shim = getOwn(k.shim, e.id), this.depExports = [], this.depMaps = [], this.depMatched = [], this.pluginMaps = {}, this.depCount = 0
        }, b.prototype = {
                ...
                this.depMaps.push(i), l(i, "defined", bind(this, function(i) {
                    ...
                    return this.map.unnormalized ? (i.normalize && (p = i.normalize(p, function(e) {
                        ...
                        var o = e.name,
                            l = a(o),
                            c = useInteractive;
                        i && (n = i), c && (useInteractive = !1), s(l), hasProp(k.config, t) && (k.config[o] = k.config[t]);
                        try {
                            req.exec(n)
                        } catch (d) {
            ...
            enable: function() {
                E[this.map.id] = this, this.enabled = !0, this.enabling = !0, each(this.depMaps, bind(this, function(e, t) {
                    ...
                    n = e.id, i = T[n], hasProp(x, n) || !i || i.enabled || w.enable(e, this)
            ...
            configure: function(e) {
                ...
                }), k.pkgs = t), eachProp(T, function(e, t) {
            ...
            makeRequire: function(t, r) {
                function o(n, i, l) {
                    ...
                    return r.enableBuildCallback && i && isFunction(i) && (i.__requireJsBuild = !0), "string" == typeof n ? isFunction(i) ? u(makeError("requireargs", "Invalid require call"), l) : t && hasProp(x, n) ? x[n](T[t.id]) : req.get ? req.get(w, n, t, o) : (d = a(n, t, !1, !0), c = d.id, hasProp(S, c) ? S[c] : u(makeError("notloaded", 'Module name "' + c + '" has not been loaded yet for context: ' + e + (t ? "" : ". Use require([])")))) : (v(), w.nextTick(function() {
                        v(), p = s(a(null, t)), p.skipMap = r.skipMap, p.init(n, i, l, {
                            enabled: !0
                        }), h()
                    }), o)
                }
                return r = r || {}, mixin(o, {
                    ...
                    specified: function(e) {
                        return e = a(e, t, !1, !0).id, hasProp(S, e) || hasProp(T, e)
                    }
            ...
            completeLoad: function(e) {
                ...
                if (i = getOwn(T, e), !t && !hasProp(S, e) && i && !i.inited) {
                    if (!(!k.enforceDefine || a && getGlobal(a))) return r(e) ? void 0 : u(makeError("nodefine", "No define call for " + e, null, [e]));
            ...
            nameToUrl: function(e, t, n) {
                ...
                if (req.jsExtRegExp.test(e)) c = e + (t || "");
                    ...
                    for (i = k.paths, r = k.pkgs, s = e.split("/"), l = s.length; l > 0; l -= 1) {
                    ...
                    c = s.join("/"), c += t || (/^data\:|\?/.test(c) || n ? "" : ".js"), c = ("/" === c.charAt(0) || c.match(/^[\w\+\.\-]+:/) ? "" : k.baseUrl) + c
                }
                return k.urlArgs ? c + ((-1 === c.indexOf("?") ? "?" : "&") + k.urlArgs) : c
            },
            load: function(e, t) {
                req.load(w, e, t)
            },
    ...
    var e, t, n, i, r, o, a, s, l, u, c, d, p, h, f, g, m, y = [],
        ...
        E = function(e) {
            var t, n, i = [];
            for (t = T(e), n = 0; n < t.length; n++) i.push(t[n]), i.push.apply(i, E(t[n]));
            return i
        },
        D = function(e) {
            var t;
        ...
        A = function(e) {
            ...
            for (t = C(e), t.unshift(e), n = 0; n < t.length; n++)
                for (i = S(t[n]), r = 0; r < i.length; r++) o.push(i[r]), o.push.apply(o, E(i[r]));
            return o
        },
        P = function(e) {
            var t, n, i, r, o = [];
            for (t = C(e), t.unshift(e), n = 0; n < t.length; n++)
                for (i = N(t[n]), r = 0; r < i.length; r++) o.push.apply(o, E(i[r]).reverse()), o.push(i[r]);
            return o
        },
        k = function(e) {
            switch (e.nodeType) {
    ...
    return nodeAttribute = function(e) {
        ...
        if (e instanceof g)
        ...
        } else if (t instanceof DateType || t instanceof h && t.isDateString()) {
            for (t instanceof h && (t = new DateType(t)), a = e.stringValues(), r = 0; r < a.length; r++)
                if (l = compareOperator(new DateType(a[r].toDate()), t, n, i), l.toBoolean()) return l
        } else {
            if (!(t instanceof h)) return compareOperator(new p(e.toBoolean()), t, n, i);
            for (a = e.stringValues(), r = 0; r < a.length; r++)
            ...
            } else if (e instanceof DateType || e instanceof h && e.isDateString()) {
            for (e instanceof h && (e = new DateType(e)), s = t.stringValues(), r = 0; r < s.length; r++)
                if (l = compareOperator(e, new DateType(s[r].toDate()), n, i), l.toBoolean()) return l
        } else {
            if (!(e instanceof h)) return compareOperator(e, new p(t.toBoolean()), n, i);
            for (s = t.stringValues(), r = 0; r < s.length; r++)
                if (l = compareOperator(e, s[r], n, i), l.toBoolean()) return l
        } else switch (n) {
            case "=":
            case "!=":
                return new p(e instanceof p || t instanceof p ? i(e.toBoolean(), t.toBoolean()) : e instanceof f || t instanceof f ? i(e.toNumber(), t.toNumber()) : i(e.toString(), t.toString()));
            default:
                return new p(i(e.toNumber(), t.toNumber()))
        }
        return new p(!1)
        ...
        return new h(this.toString()).toNumber()
    }, g.prototype.toNodeSet = function() {
        return this.value
    }, g.prototype.toDate = function() {
        return new h(this.toString()).toDate()
        ...
        var e, t, n = [];
        for (e = 0; e < this.value.length; e++) t = new h(nodeStringValue(this.value[e])), t.isDateString() && (t = new DateType(t.value)), n.push(t);
        return n
    }, h = function(e) {
    ...
    }, h.prototype.isDateString = function() {
        return isNaN(this.value) ? isNaN(Date.parse(this.value)) ? !1 : (console.debug("found string value that passes check for datestringiness: " + this.value), !0) : !1
    }, f = function(e) {
        ...
        this.opts["unique-ids"][b] = "id", this.opts["unique-ids"][_] = "id"
    }, t.prototype = {
        opts: {
            "unique-ids": {},
            "case-sensitive": !1
        ...
        "/": function(e, t) {
            var n, i, r, o, a;
            if (null === e) i = new g([k(this.node)], "document-order");
        ...
        step: function(e, t) {
            ...
            switch (e) {
                case "child":
                    n = new g(T(this.node), "document-order");
                    break;
                case "descendant":
                    n = new g(E(this.node), "document-order");
                    break;
                case "parent":
                ...
                case "descendant-or-self":
                    o = E(this.node), o.unshift(this.node), n = new g(o, "document-order");
                    break;
        ...
        "function": function(e, t) {
            ...
            for (i = this.fns[n.ns][n.name], i.args || (i.args = []), r = 0, c = 0; r < i.args.length; c++, r++) {
                ...
                } else p.push(void 0 === i.args[r].t ? "object" : i.args[r].t); if (i.args[r].rep === !0) {
                    for (; c < t.length; c++) p.push(void 0 === i.args[r].t ? "object" : i.args[r].t);
                    break
                }
            }
            if (p.length < t.length) throw new Error('Function "' + l(n) + '" expects ' + u(i.args) + ".");
            for (r = 0; r < t.length; r++) {
                if (o = s(this, t[r]), "object" !== p[r] && !o.canConvertTo(p[r])) throw new Error('Function "' + l(n) + '" expects ' + u(i.args) + '.Cannot convert "' + o.type + '" to "' + p[r] + '".');
                a.push(o)
            }
        ...
        or: function(e, t) {
            return new p(s(this, e).toBoolean() ? !0 : s(this, t).toBoolean())
        },
        and: function(e, t) {
            return new p(s(this, e).toBoolean() ? s(this, t).toBoolean() : !1)
        },
        "=": function(e, t) {
        ...
        "": {
            ...
            id: {
                fn: function(e) {
                    ...
                    for (t = 0; t < o.length; t++) i = k(this.node).getElementById(o[t]), i && nodeIdAttribute.call(this, i) ? a.push(i) : nodeAttributeSearch(k(this.node), !0, function(e, n) {
            ...
            "local-name": {
                fn: function(e) {
                    var t, n = "";
                    return 0 == arguments.length && (e = new g([this.node])), e.toNodeSet().length > 0 && (e.sortDocumentOrder(), t = nodeExpandedName.call(this, e.value[0]), t !== !1 && (n = t.name)), new h(n)
                },
                args: [{
                    t: "node-set",
                    r: !1
            ...
            "namespace-uri": {
                fn: function(e) {
                    var t, n = "";
                    return 0 == arguments.length && (e = new g([this.node])), e.toNodeSet().length > 0 && (e.sortDocumentOrder(), t = nodeExpandedName.call(this, e.value[0]), t !== !1 && null !== t.ns && (n = t.ns)), new h(n)
                },
                args: [{
                    t: "node-set",
                    r: !1
            ...
            name: {
                fn: function(e) {
                    var t, n = "";
                    return 0 == arguments.length && (e = new g([this.node])), e.toNodeSet().length > 0 && (e.sortDocumentOrder(), t = nodeExpandedName.call(this, e.value[0]), t !== !1 && (n = t.prefix && t.prefix.length > 0 ? t.prefix + ":" + t.name : t.name)), new h(n)
                },
                args: [{
                    t: "node-set",
                    r: !1
            ...
            string: {
                fn: function(e) {
                    return 0 == arguments.length && (e = new g([this.node], "document-order")), new h(e.toString())
                },
                args: [{
                    t: "object",
                    r: !1
            ...
            "starts-with": {
                fn: function(e, t) {
                    return new p(e.toString().substr(0, (t = t.toString()).length) == t)
                },
                args: [{
                    t: "string"
                }, {
            ...
            contains: {
                fn: function(e, t) {
                    return new p(-1 != e.toString().indexOf(t = t.toString()))
                },
                args: [{
                    t: "string"
                }, {
            ...
            "substring-before": {
                fn: function(e, t) {
                    return e = e.toString(), t = e.indexOf(t.toString()), new h(-1 == t ? "" : e.substr(0, t))
                },
                args: [{
                    t: "string"
                }, {
            ...
            "substring-after": {
                fn: function(e, t) {
                    var n;
                    return e = e.toString(), t = t.toString(), n = e.indexOf(t), new h(-1 == n ? "" : e.substr(n + t.length))
                },
                args: [{
                    t: "string"
                }, {
            ...
            substring: {
                fn: function(e, t, n) {
                    return e = e.toString(), t = Math.round(t.toNumber()) - 1, new h(isNaN(t) ? "" : 2 == arguments.length ? e.substring(0 > t ? 0 : t) : e.substring(0 > t ? 0 : t, t + Math.round(n.toNumber())))
                },
                args: [{
                    t: "string"
                }, {
            ...
            "normalize-space": {
                fn: function(e) {
                    return e = 0 == arguments.length ? nodeStringValue(this.node) : e.toString(), new h(e.replace(/^[\u0020\u0009\u000D\u000A]+/, "").replace(/[\u0020\u0009\u000D\u000A]+$/, "").replace(/[\u0020\u0009\u000D\u000A]+/g, " "))
                },
                args: [{
                    t: "string",
                    r: !1
                            ...
                            if (n = t[o].nodeName.split(":"), 1 === n.length && (n[1] = n[0], n[0] = ""), "lang" == n[1]) {
                                ...
                                if (s)
                                    for (r = nodeNamespace.call(this, l), a = 0; a < r.length; a++)
                                        if (r[a].prefix == n[0] && r[a].nodeValue == b) return new p(!0)
                            }
                    return new p(!1)
                },
                args: [{
            ...
            sum: {
                fn: function(e) {
                    var t, n = 0;
                    for (e = e.toNodeSet(), t = 0; t < e.length; t++) n += new h(nodeStringValue(e[t])).toNumber();
                    return new f(n)
                },
                args: [{
                    t: "node-set"
            ...
            sum_jr: {
                fn: function(e) {
                    var t, n;
                    for (sum = 0, e = e.toNodeSet(), t = 0; t < e.length; t++) n = "" == nodeStringValue(e[t]) ? "0" : nodeStringValue(e[t]), sum += new h(n).toNumber();
                    return new f(sum)
                },
                args: [{
                    t: "node-set"
            ...
            selected: {
                fn: function(e, t) {
                    var n;
                    return t = t.toString().trim(), n = e.toString(), new p(-1 != (" " + n + " ").indexOf(" " + t + " "))
                },
                args: [{
                    t: "object"
                }, {
            ...
            "selected-at": {
                fn: function(e, t) {
                    var n, i, r;
                    return t = Math.round(t.toNumber()), n = e.toString(), i = n.split(" "), r = t >= 0 && t < i.length ? i[t] : "", new h(r)
                },
                args: [{
                    t: "object"
                }, {
            ...
            "boolean-from-string": {
                fn: function(e) {
                    return new p("true" === e.toString().toLowerCase() || "1" === String(e))
                },
                args: [{
                    t: "string"
                }],
            ...
            regex: {
                fn: function(e, t) {
                    var n, i;
                    return n = e.toString(), i = new RegExp(t), new p(i.test(n))
                },
                args: [{
                    t: "object"
                }, {
            ...
            substr: {
                fn: function(e, t, n) {
                    return e = e.toString(), length = e.length, t = Math.round(t.toNumber()), n = n ? Math.round(n.toNumber()) : length, new h(isNaN(t) ? "" : e.substring(0 > t ? length + t : t, 0 > n ? length + n : n))
                },
                args: [{
                    t: "string"
                }, {
            ...
            min: {
                fn: function(e) {
                    var t, n, i;
                    for (e = e.toNodeSet(), t = 0; t < e.length; t++) i = new h(nodeStringValue(e[t])), i && "" !== i.toString() && (n = n ? Math.min(n, i.toNumber()) : i.toNumber());
                    return new f(n)
                },
                args: [{
                    t: "node-set"
            ...
            max: {
                fn: function(e) {
                    var t, n, i;
                    for (e = e.toNodeSet(), t = 0; t < e.length; t++) i = new h(nodeStringValue(e[t])), i && "" !== i.toString() && (n = n ? Math.max(n, i.toNumber()) : i.toNumber());
                    return new f(n)
                },
                args: [{
                    t: "node-set"
            ...
            "format-date": {
                fn: function(e, t) {
                    ...
                    if (!e.toBoolean()) return new h(i.toString());
                    props = {
                        Y: i.getFullYear(),
        ...
        else if (i instanceof p) o = new r(t, r.BOOLEAN_TYPE, i);
        else {
            if (!(i instanceof h)) throw new e(e.TYPE_ERR, "Internal Error: Unsupported value type: " + typeof i);
    ...
    function n(e) {
        ...
        function a() {
            var e, t, n, i;
            return e = dr, t = V(), t !== J ? (n = y(), n !== J ? (i = V(), i !== J ? (pr = e, t = et(n), e = t) : (dr = e, e = Z)) : (dr = e, e = Z)) : (dr = e, e = Z), e
        }
        ...
        function l() {
            var t, n, i, o, a;
            return t = g(), t === J && (t = dr, 47 === e.charCodeAt(dr) ? (n = tt, dr++) : (n = J, 0 === vr && r(nt)), n !== J ? (i = dr, o = V(), o !== J ? (a = u(), a !== J ? (o = [o, a], i = o) : (dr = i, i = Z)) : (dr = i, i = Z), i === J && (i = it), i !== J ? (pr = t, n = rt(i), t = n) : (dr = t, t = Z)) : (dr = t, t = Z)), t
        }
        ...
        function u() {
            ...
            if (t = dr, n = c(), n !== J) {
                ...
                i !== J ? (pr = t, n = st(n, i), t = n) : (dr = t, t = Z)
            } else dr = t, t = Z;
            return t
        }
            ...
            if (e = dr, t = d(), t !== J)
                if (n = V(), n !== J)
                    if (i = h(), i !== J) {
                        ...
                        r !== J ? (pr = e, t = lt(t, i, r), e = t) : (dr = e, e = Z)
                    } else dr = e, e = Z;
            else dr = e, e = Z;
            else dr = e, e = Z;
            return e === J && (e = m()), e
        ...
        function d() {
            var t, n, i, o;
            return t = dr, n = p(), n !== J ? (i = V(), i !== J ? (e.substr(dr, 2) === ut ? (o = ut, dr += 2) : (o = J, 0 === vr && r(ct)), o !== J ? (pr = t, n = dt(n), t = n) : (dr = t, t = Z)) : (dr = t, t = Z)) : (dr = t, t = Z), t === J && (t = dr, n = v(), n !== J && (pr = t, n = pt(n)), t = n), t
        }

        function p() {
            var t;
            return e.substr(dr, 16) === ht ? (t = ht, dr += 16) : (t = J, 0 === vr && r(ft)), t === J && (e.substr(dr, 8) === gt ? (t = gt, dr += 8) : (t = J, 0 === vr && r(mt)), t === J && (e.substr(dr, 9) === vt ? (t = vt, dr += 9) : (t = J, 0 === vr && r(yt)), t === J && (e.substr(dr, 5) === bt ? (t = bt, dr += 5) : (t = J, 0 === vr && r(wt)), t === J && (e.substr(dr, 18) === xt ? (t = xt, dr += 18) : (t = J, 0 === vr && r(_t)), t === J && (e.substr(dr, 10) === kt ? (t = kt, dr += 10) : (t = J, 0 === vr && r(Tt)), t === J && (e.substr(dr, 17) === Et ? (t = Et, dr += 17) : (t = J, 0 === vr && r(Dt)), t === J && (e.substr(dr, 9) === Ct ? (t = Ct, dr += 9) : (t = J, 0 === vr && r(St)), t === J && (e.substr(dr, 9) === Nt ? (t = Nt, dr += 9) : (t = J, 0 === vr && r(Mt)), t === J && (e.substr(dr, 6) === At ? (t = At, dr += 6) : (t = J, 0 === vr && r(Pt)), t === J && (e.substr(dr, 17) === Ot ? (t = Ot, dr += 17) : (t = J, 0 === vr && r($t)), t === J && (e.substr(dr, 9) === Rt ? (t = Rt, dr += 9) : (t = J, 0 === vr && r(jt)), t === J && (e.substr(dr, 4) === It ? (t = It, dr += 4) : (t = J, 0 === vr && r(Ft)))))))))))))), t
        }

        function h() {
            var t, n, i, o, a, s, l, u;
            return t = dr, n = F(), n !== J ? (i = V(), i !== J ? (40 === e.charCodeAt(dr) ? (o = qt, dr++) : (o = J, 0 === vr && r(Vt)), o !== J ? (a = V(), a !== J ? (41 === e.charCodeAt(dr) ? (s = Lt, dr++) : (s = J, 0 === vr && r(Ut)), s !== J ? (pr = t, n = Bt(n), t = n) : (dr = t, t = Z)) : (dr = t, t = Z)) : (dr = t, t = Z)) : (dr = t, t = Z)) : (dr = t, t = Z), t === J && (t = dr, e.substr(dr, 22) === Ht ? (n = Ht, dr += 22) : (n = J, 0 === vr && r(Wt)), n !== J ? (i = V(), i !== J ? (40 === e.charCodeAt(dr) ? (o = qt, dr++) : (o = J, 0 === vr && r(Vt)), o !== J ? (a = V(), a !== J ? (s = A(), s !== J ? (l = V(), l !== J ? (41 === e.charCodeAt(dr) ? (u = Lt, dr++) : (u = J, 0 === vr && r(Ut)), u !== J ? (pr = t, n = zt(n, s), t = n) : (dr = t, t = Z)) : (dr = t, t = Z)) : (dr = t, t = Z)) : (dr = t, t = Z)) : (dr = t, t = Z)) : (dr = t, t = Z)) : (dr = t, t = Z), t === J && (t = dr, n = I(), n !== J && (pr = t, n = Xt(n)), t = n)), t
        }

        function f() {
            var t, n, i, o, a, s;
            return t = dr, 91 === e.charCodeAt(dr) ? (n = Yt, dr++) : (n = J, 0 === vr && r(Kt)), n !== J ? (i = V(), i !== J ? (o = y(), o !== J ? (a = V(), a !== J ? (93 === e.charCodeAt(dr) ? (s = Jt, dr++) : (s = J, 0 === vr && r(Qt)), s !== J ? (pr = t, n = Gt(o), t = n) : (dr = t, t = Z)) : (dr = t, t = Z)) : (dr = t, t = Z)) : (dr = t, t = Z)) : (dr = t, t = Z), t
        }

        function g() {
            var t, n, i, o;
            return t = dr, e.substr(dr, 2) === ot ? (n = ot, dr += 2) : (n = J, 0 === vr && r(at)), n !== J ? (i = V(), i !== J ? (o = u(), o !== J ? (pr = t, n = Zt(o), t = n) : (dr = t, t = Z)) : (dr = t, t = Z)) : (dr = t, t = Z), t
        }

        function m() {
            var t, n;
            return t = dr, e.substr(dr, 2) === en ? (n = en, dr += 2) : (n = J, 0 === vr && r(tn)), n === J && (46 === e.charCodeAt(dr) ? (n = nn, dr++) : (n = J, 0 === vr && r(rn))), n !== J && (pr = t, n = on(n)), t = n
        }

        function v() {
            var t, n;
            return t = dr, 64 === e.charCodeAt(dr) ? (n = an, dr++) : (n = J, 0 === vr && r(sn)), n === J && (n = it), n !== J && (pr = t, n = ln(n)), t = n
        }

        function y() {
            var e, t;
            return e = dr, t = T(), t !== J && (pr = e, t = Gt(t)), e = t
        }

        function b() {
            var t, n, i, o, a, s;
            return t = dr, n = j(), n !== J && (pr = t, n = un(n)), t = n, t === J && (t = dr, 40 === e.charCodeAt(dr) ? (n = qt, dr++) : (n = J, 0 === vr && r(Vt)), n !== J ? (i = V(), i !== J ? (o = y(), o !== J ? (a = V(), a !== J ? (41 === e.charCodeAt(dr) ? (s = Lt, dr++) : (s = J, 0 === vr && r(Ut)), s !== J ? (pr = t, n = Gt(o), t = n) : (dr = t, t = Z)) : (dr = t, t = Z)) : (dr = t, t = Z)) : (dr = t, t = Z)) : (dr = t, t = Z), t === J && (t = dr, n = A(), n !== J && (pr = t, n = cn(n)), t = n, t === J && (t = dr, n = P(), n !== J && (pr = t, n = dn(n)), t = n, t === J && (t = w())))), t
        }

        function w() {
            var t, n, i, o, a, s, l, u, c, d, p, h, f;
            if (t = dr, n = R(), n !== J)
                if (i = V(), i !== J)
                    if (40 === e.charCodeAt(dr) ? (o = qt, dr++) : (o = J, 0 === vr && r(Vt)), o !== J) {
                        if (a = dr, s = V(), s !== J)
                            if (l = y(), l !== J) {
                                for (u = [], c = dr, d = V(), d !== J ? (44 === e.charCodeAt(dr) ? (p = pn, dr++) : (p = J, 0 === vr && r(hn)), p !== J ? (h = V(), h !== J ? (f = y(), f !== J ? (d = [d, p, h, f], c = d) : (dr = c, c = Z)) : (dr = c, c = Z)) : (dr = c, c = Z)) : (dr = c, c = Z); c !== J;) u.push(c), c = dr, d = V(), d !== J ? (44 === e.charCodeAt(dr) ? (p = pn, dr++) : (p = J, 0 === vr && r(hn)), p !== J ? (h = V(), h !== J ? (f = y(), f !== J ? (d = [d, p, h, f], c = d) : (dr = c, c = Z)) : (dr = c, c = Z)) : (dr = c, c = Z)) : (dr = c, c = Z);
                                u !== J ? (s = [s, l, u], a = s) : (dr = a, a = Z)
                            } else dr = a, a = Z;
                        else dr = a, a = Z;
                        a === J && (a = it), a !== J ? (s = V(), s !== J ? (41 === e.charCodeAt(dr) ? (l = Lt, dr++) : (l = J, 0 === vr && r(Ut)), l !== J ? (pr = t, n = fn(n, a), t = n) : (dr = t, t = Z)) : (dr = t, t = Z)) : (dr = t, t = Z)
                    } else dr = t, t = Z;
            else dr = t, t = Z;
            else dr = t, t = Z;
            return t
        ...
        function x() {
            var t, n, i, o, a, s, l, u;
            if (t = dr, n = _(), n !== J) {
                for (i = [], o = dr, a = V(), a !== J ? (124 === e.charCodeAt(dr) ? (s = gn, dr++) : (s = J, 0 === vr && r(mn)), s !== J ? (l = V(), l !== J ? (u = _(), u !== J ? (a = [a, s, l, u], o = a) : (dr = o, o = Z)) : (dr = o, o = Z)) : (dr = o, o = Z)) : (dr = o, o = Z); o !== J;) i.push(o), o = dr, a = V(), a !== J ? (124 === e.charCodeAt(dr) ? (s = gn, dr++) : (s = J, 0 === vr && r(mn)), s !== J ? (l = V(), l !== J ? (u = _(), u !== J ? (a = [a, s, l, u], o = a) : (dr = o, o = Z)) : (dr = o, o = Z)) : (dr = o, o = Z)) : (dr = o, o = Z);
                i !== J ? (pr = t, n = vn(n, i), t = n) : (dr = t, t = Z)
            } else dr = t, t = Z;
            return t
        }
        ...
        function _() {
            var t, n, i, o, a, l, c;
            return t = dr, n = k(), n !== J ? (i = dr, o = V(), o !== J ? (e.substr(dr, 2) === ot ? (a = ot, dr += 2) : (a = J, 0 === vr && r(at)), a === J && (47 === e.charCodeAt(dr) ? (a = tt, dr++) : (a = J, 0 === vr && r(nt))), a !== J ? (l = V(), l !== J ? (c = u(), c !== J ? (o = [o, a, l, c], i = o) : (dr = i, i = Z)) : (dr = i, i = Z)) : (dr = i, i = Z)) : (dr = i, i = Z), i === J && (i = it), i !== J ? (pr = t, n = yn(n, i), t = n) : (dr = t, t = Z)) : (dr = t, t = Z), t === J && (t = dr, n = s(), n !== J && (pr = t, n = bn(n)), t = n), t
        }
        ...
        function k() {
            ...
            if (e = dr, t = b(), t !== J) {
                ...
                n !== J ? (pr = e, t = wn(t, n), e = t) : (dr = e, e = Z)
            } else dr = e, e = Z;
            return e
        }
        ...
        function T() {
            var t, n, i, o, a, s, l, u;
            if (t = dr, n = E(), n !== J) {
                for (i = [], o = dr, a = V(), a !== J ? (e.substr(dr, 2) === xn ? (s = xn, dr += 2) : (s = J, 0 === vr && r(_n)), s !== J ? (l = V(), l !== J ? (u = E(), u !== J ? (a = [a, s, l, u], o = a) : (dr = o, o = Z)) : (dr = o, o = Z)) : (dr = o, o = Z)) : (dr = o, o = Z); o !== J;) i.push(o), o = dr, a = V(), a !== J ? (e.substr(dr, 2) === xn ? (s = xn, dr += 2) : (s = J, 0 === vr && r(_n)), s !== J ? (l = V(), l !== J ? (u = E(), u !== J ? (a = [a, s, l, u], o = a) : (dr = o, o = Z)) : (dr = o, o = Z)) : (dr = o, o = Z)) : (dr = o, o = Z);
                i !== J ? (pr = t, n = vn(n, i), t = n) : (dr = t, t = Z)
            } else dr = t, t = Z;
            return t
        }
        ...
        function E() {
            var t, n, i, o, a, s, l, u;
            if (t = dr, n = D(), n !== J) {
                for (i = [], o = dr, a = V(), a !== J ? (e.substr(dr, 3) === kn ? (s = kn, dr += 3) : (s = J, 0 === vr && r(Tn)), s !== J ? (l = V(), l !== J ? (u = D(), u !== J ? (a = [a, s, l, u], o = a) : (dr = o, o = Z)) : (dr = o, o = Z)) : (dr = o, o = Z)) : (dr = o, o = Z); o !== J;) i.push(o), o = dr, a = V(), a !== J ? (e.substr(dr, 3) === kn ? (s = kn, dr += 3) : (s = J, 0 === vr && r(Tn)), s !== J ? (l = V(), l !== J ? (u = D(), u !== J ? (a = [a, s, l, u], o = a) : (dr = o, o = Z)) : (dr = o, o = Z)) : (dr = o, o = Z)) : (dr = o, o = Z);
                i !== J ? (pr = t, n = vn(n, i), t = n) : (dr = t, t = Z)
            } else dr = t, t = Z;
            return t
        }
        ...
        function D() {
            var t, n, i, o, a, s, l, u;
            if (t = dr, n = C(), n !== J) {
                for (i = [], o = dr, a = V(), a !== J ? (61 === e.charCodeAt(dr) ? (s = En, dr++) : (s = J, 0 === vr && r(Dn)), s === J && (e.substr(dr, 2) === Cn ? (s = Cn, dr += 2) : (s = J, 0 === vr && r(Sn))), s !== J ? (l = V(), l !== J ? (u = C(), u !== J ? (a = [a, s, l, u], o = a) : (dr = o, o = Z)) : (dr = o, o = Z)) : (dr = o, o = Z)) : (dr = o, o = Z); o !== J;) i.push(o), o = dr, a = V(), a !== J ? (61 === e.charCodeAt(dr) ? (s = En, dr++) : (s = J, 0 === vr && r(Dn)), s === J && (e.substr(dr, 2) === Cn ? (s = Cn, dr += 2) : (s = J, 0 === vr && r(Sn))), s !== J ? (l = V(), l !== J ? (u = C(), u !== J ? (a = [a, s, l, u], o = a) : (dr = o, o = Z)) : (dr = o, o = Z)) : (dr = o, o = Z)) : (dr = o, o = Z);
                i !== J ? (pr = t, n = vn(n, i), t = n) : (dr = t, t = Z)
            } else dr = t, t = Z;
            return t
        }
        ...
        function C() {
            var t, n, i, o, a, s, l, u;
            if (t = dr, n = S(), n !== J) {
                for (i = [], o = dr, a = V(), a !== J ? (e.substr(dr, 2) === Nn ? (s = Nn, dr += 2) : (s = J, 0 === vr && r(Mn)), s === J && (60 === e.charCodeAt(dr) ? (s = An, dr++) : (s = J, 0 === vr && r(Pn)), s === J && (e.substr(dr, 2) === On ? (s = On, dr += 2) : (s = J, 0 === vr && r($n)), s === J && (62 === e.charCodeAt(dr) ? (s = Rn, dr++) : (s = J, 0 === vr && r(jn))))), s !== J ? (l = V(), l !== J ? (u = S(), u !== J ? (a = [a, s, l, u], o = a) : (dr = o, o = Z)) : (dr = o, o = Z)) : (dr = o, o = Z)) : (dr = o, o = Z); o !== J;) i.push(o), o = dr, a = V(), a !== J ? (e.substr(dr, 2) === Nn ? (s = Nn, dr += 2) : (s = J, 0 === vr && r(Mn)), s === J && (60 === e.charCodeAt(dr) ? (s = An, dr++) : (s = J, 0 === vr && r(Pn)), s === J && (e.substr(dr, 2) === On ? (s = On, dr += 2) : (s = J, 0 === vr && r($n)), s === J && (62 === e.charCodeAt(dr) ? (s = Rn, dr++) : (s = J, 0 === vr && r(jn))))), s !== J ? (l = V(), l !== J ? (u = S(), u !== J ? (a = [a, s, l, u], o = a) : (dr = o, o = Z)) : (dr = o, o = Z)) : (dr = o, o = Z)) : (dr = o, o = Z);
                i !== J ? (pr = t, n = vn(n, i), t = n) : (dr = t, t = Z)
            } else dr = t, t = Z;
            return t
        }
        ...
        function S() {
            var t, n, i, o, a, s, l, u;
            if (t = dr, n = N(), n !== J) {
                for (i = [], o = dr, a = V(), a !== J ? (43 === e.charCodeAt(dr) ? (s = In, dr++) : (s = J, 0 === vr && r(Fn)), s === J && (45 === e.charCodeAt(dr) ? (s = qn, dr++) : (s = J, 0 === vr && r(Vn))), s !== J ? (l = V(), l !== J ? (u = N(), u !== J ? (a = [a, s, l, u], o = a) : (dr = o, o = Z)) : (dr = o, o = Z)) : (dr = o, o = Z)) : (dr = o, o = Z); o !== J;) i.push(o), o = dr, a = V(), a !== J ? (43 === e.charCodeAt(dr) ? (s = In, dr++) : (s = J, 0 === vr && r(Fn)), s === J && (45 === e.charCodeAt(dr) ? (s = qn, dr++) : (s = J, 0 === vr && r(Vn))), s !== J ? (l = V(), l !== J ? (u = N(), u !== J ? (a = [a, s, l, u], o = a) : (dr = o, o = Z)) : (dr = o, o = Z)) : (dr = o, o = Z)) : (dr = o, o = Z);
                i !== J ? (pr = t, n = vn(n, i), t = n) : (dr = t, t = Z)
            } else dr = t, t = Z;
            return t
        }
        ...
        function N() {
            var t, n, i, o, a, s, l, u;
            if (t = dr, n = M(), n !== J) {
                for (i = [], o = dr, a = V(), a !== J ? (s = $(), s === J && (e.substr(dr, 3) === Ln ? (s = Ln, dr += 3) : (s = J, 0 === vr && r(Un)), s === J && (e.substr(dr, 3) === Bn ? (s = Bn, dr += 3) : (s = J, 0 === vr && r(Hn)))), s !== J ? (l = V(), l !== J ? (u = M(), u !== J ? (a = [a, s, l, u], o = a) : (dr = o, o = Z)) : (dr = o, o = Z)) : (dr = o, o = Z)) : (dr = o, o = Z); o !== J;) i.push(o), o = dr, a = V(), a !== J ? (s = $(), s === J && (e.substr(dr, 3) === Ln ? (s = Ln, dr += 3) : (s = J, 0 === vr && r(Un)), s === J && (e.substr(dr, 3) === Bn ? (s = Bn, dr += 3) : (s = J, 0 === vr && r(Hn)))), s !== J ? (l = V(), l !== J ? (u = M(), u !== J ? (a = [a, s, l, u], o = a) : (dr = o, o = Z)) : (dr = o, o = Z)) : (dr = o, o = Z)) : (dr = o, o = Z);
                i !== J ? (pr = t, n = vn(n, i), t = n) : (dr = t, t = Z)
            } else dr = t, t = Z;
            return t
        }
        ...
        function M() {
            var t, n, i, o;
            return t = dr, n = x(), n !== J && (pr = t, n = Gt(n)), t = n, t === J && (t = dr, 45 === e.charCodeAt(dr) ? (n = qn, dr++) : (n = J, 0 === vr && r(Vn)), n !== J ? (i = V(), i !== J ? (o = M(), o !== J ? (pr = t, n = Wn(o), t = n) : (dr = t, t = Z)) : (dr = t, t = Z)) : (dr = t, t = Z)), t
        }
        ...
        function A() {
            ...
            if (t = dr, 34 === e.charCodeAt(dr) ? (n = zn, dr++) : (n = J, 0 === vr && r(Xn)), n !== J) {
                ...
                i !== J ? (34 === e.charCodeAt(dr) ? (o = zn, dr++) : (o = J, 0 === vr && r(Xn)), o !== J ? (pr = t, n = Jn(i), t = n) : (dr = t, t = Z)) : (dr = t, t = Z)
                ...
                if (t = dr, 39 === e.charCodeAt(dr) ? (n = Qn, dr++) : (n = J, 0 === vr && r(Gn)), n !== J) {
                    ...
                    i !== J ? (39 === e.charCodeAt(dr) ? (o = Qn, dr++) : (o = J, 0 === vr && r(Gn)), o !== J ? (pr = t, n = Jn(i), t = n) : (dr = t, t = Z)) : (dr = t, t = Z)
                } else dr = t, t = Z;
            return t
        }
        ...
        function P() {
            var t, n, i, o, a;
            return t = dr, n = O(), n !== J ? (i = dr, 46 === e.charCodeAt(dr) ? (o = nn, dr++) : (o = J, 0 === vr && r(rn)), o !== J ? (a = O(), a === J && (a = it), a !== J ? (o = [o, a], i = o) : (dr = i, i = Z)) : (dr = i, i = Z), i === J && (i = it), i !== J ? (pr = t, n = ti(n, i), t = n) : (dr = t, t = Z)) : (dr = t, t = Z), t === J && (t = dr, 46 === e.charCodeAt(dr) ? (n = nn, dr++) : (n = J, 0 === vr && r(rn)), n !== J ? (i = O(), i !== J ? (pr = t, n = ni(i), t = n) : (dr = t, t = Z)) : (dr = t, t = Z)), t
        }
        ...
        function R() {
            var e, t, n;
            return e = dr, t = L(), t !== J ? (pr = dr, n = li(t), n = n ? ui : Z, n !== J ? (pr = e, t = ci(t), e = t) : (dr = e, e = Z)) : (dr = e, e = Z), e
        }

        function j() {
            var t, n, i;
            return t = dr, 36 === e.charCodeAt(dr) ? (n = di, dr++) : (n = J, 0 === vr && r(pi)), n !== J ? (i = L(), i !== J ? (pr = t, n = hi(i), t = n) : (dr = t, t = Z)) : (dr = t, t = Z), t
        }

        function I() {
            var t, n, i, o;
            return t = dr, 42 === e.charCodeAt(dr) ? (n = ai, dr++) : (n = J, 0 === vr && r(si)), n !== J && (pr = t, n = fi()), t = n, t === J && (t = dr, n = H(), n !== J ? (58 === e.charCodeAt(dr) ? (i = gi, dr++) : (i = J, 0 === vr && r(mi)), i !== J ? (42 === e.charCodeAt(dr) ? (o = ai, dr++) : (o = J, 0 === vr && r(si)), o !== J ? (pr = t, n = vi(n), t = n) : (dr = t, t = Z)) : (dr = t, t = Z)) : (dr = t, t = Z), t === J && (t = dr, n = L(), n !== J && (pr = t, n = yi(n)), t = n)), t
        }

        function F() {
            var t;
            return e.substr(dr, 7) === bi ? (t = bi, dr += 7) : (t = J, 0 === vr && r(wi)), t === J && (e.substr(dr, 4) === xi ? (t = xi, dr += 4) : (t = J, 0 === vr && r(_i)), t === J && (e.substr(dr, 22) === Ht ? (t = Ht, dr += 22) : (t = J, 0 === vr && r(Wt)), t === J && (e.substr(dr, 4) === ki ? (t = ki, dr += 4) : (t = J, 0 === vr && r(Ti))))), t
        }

        function q() {
            var t, n;
            if (t = [], Ei.test(e.charAt(dr)) ? (n = e.charAt(dr), dr++) : (n = J, 0 === vr && r(Di)), n !== J)
                for (; n !== J;) t.push(n), Ei.test(e.charAt(dr)) ? (n = e.charAt(dr), dr++) : (n = J, 0 === vr && r(Di));
            else t = Z;
            return t
        }
        ...
        function L() {
            var e, t;
            return e = dr, t = U(), t === J && (t = B()), t !== J && (pr = e, t = Ci(t)), e = t
        }

        function U() {
            var t, n, i, o;
            return t = dr, n = H(), n !== J ? (58 === e.charCodeAt(dr) ? (i = gi, dr++) : (i = J, 0 === vr && r(mi)), i !== J ? (o = H(), o !== J ? (pr = t, n = Si(n, o), t = n) : (dr = t, t = Z)) : (dr = t, t = Z)) : (dr = t, t = Z), t
        }

        function B() {
            var e, t;
            return e = dr, t = H(), t !== J && (pr = e, t = Ni(t)), e = t
        }
        ...
        function X() {
            ...
            if (e = dr, t = W(), t !== J) {
                ...
                n !== J ? (pr = e, t = cr(t, n), e = t) : (dr = e, e = Z)
            } else dr = e, e = Z;
            return e
        }
        var Y, K = arguments.length > 1 ? arguments[1] : {},
            ...
            st = function(e, t) {
                var n;
                for (n = 0; n < t.length; n++) e = Tr(t[n][1], e, t[n][3]);
                return e
            },
            lt = function(e, t, n) {
                return wr({
        ...
        var yr, br = function(e, t, n, i) {
            ...
            kr = ["comment", "text", "processing-instruction", "node"],
            Tr = function(e, t, n) {
                return "/" == e ? {
                    type: "/",
                    args: [t, n]
    ...
    function o(e) {
        var t = ft[e] = {};
        return et.each(e.match(ht) || [], function(e, n) {
            t[n] = !0
        }), t
    }
    ...
    function E(e, t, n, i, r) {
        for (var o = n === (i ? "border" : "content") ? 4 : "width" === t ? 1 : 0, a = 0; 4 > o; o += 2) "margin" === n && (a += et.css(e, n + _t[o], !0, r)), i ? ("content" === n && (a -= et.css(e, "padding" + _t[o], !0, r)), "margin" !== n && (a -= et.css(e, "border" + _t[o] + "Width", !0, r))) : (a += et.css(e, "padding" + _t[o], !0, r), "padding" !== n && (a += et.css(e, "border" + _t[o] + "Width", !0, r)));
        return a
    }
    ...
    function C(e, t) {
        for (var n, i, r, o = [], a = 0, s = e.length; s > a; a++) i = e[a], i.style && (o[a] = vt.get(i, "olddisplay"), n = i.style.display, t ? (o[a] || "none" !== n || (i.style.display = ""), "" === i.style.display && kt(i) && (o[a] = vt.access(i, "olddisplay", w(i.nodeName)))) : o[a] || (r = kt(i), (n && "none" !== n || !r) && vt.set(i, "olddisplay", r ? n : et.css(i, "display"))));
    ...
    function P(e, t, n) {
        ...
        })), 1 === e.nodeType && ("height" in t || "width" in t) && (n.overflow = [p.overflow, p.overflowX, p.overflowY], u = et.css(e, "display"), "none" === u && (u = w(e.nodeName)), "inline" === u && "none" === et.css(e, "float") && (p.display = "inline-block")), n.overflow && (p.overflow = "hidden", c.always(function() {
        ...
        if (!et.isEmptyObject(d)) {
            f ? "hidden" in f && (h = f.hidden) : f = vt.access(e, "fxshow", {}), o && (f.hidden = !h), h ? et(e).show() : c.done(function() {
                et(e).hide()
            }), c.done(function() {
                var t;
                vt.remove(e, "fxshow");
            ...
            for (i in d) a = A(h ? f[i] : 0, i, c), i in f || (f[i] = a.start, h && (a.end = a.start, a.start = "width" === i || "height" === i ? 1 : 0))
        }
    }
    ...
    var rt = function(e) {
            ...
            if ($ && !i) {
                if (r = yt.exec(e))
                    if (a = r[1]) {
                        ...
                        if ((a = r[3]) && k.getElementsByClassName && t.getElementsByClassName) return Z.apply(n, t.getElementsByClassName(a)), n
                    }
                if (k.qsa && (!R || !R.test(e))) {
                    if (f = d = q, g = t, m = 9 === s && e, 1 === s && "object" !== t.nodeName.toLowerCase()) {
                        for (u = p(e), (d = t.getAttribute("id")) ? f = d.replace(wt, "\\$&") : t.setAttribute("id", f), f = "[id='" + f + "'] ", l = u.length; l--;) u[l] = f + h(u[l]);
        ...
        function p(e, n) {
            ...
            for (s = e, l = [], u = T.preFilter; s;) {
                ...
                for (a in T.filter) !(r = ft[a].exec(s)) || u[a] && !(r = u[a](r)) || (i = r.shift(), o.push({
                    value: i,
                    type: a,
                    matches: r
                }), s = s.slice(i.length));
        ...
        function v(e, t, n, r, o, a) {
            return r && !r[q] && (r = v(r)), o && !o[q] && (o = v(o, a)), i(function(i, a, s, l) {
                var u, c, d, p = [],
                    ...
                    y = n ? o || (i ? e : f || r) ? [] : a : v;
                if (n && n(v, y, s, l), r)
                    for (u = m(y, h), r(u, [], s, l), c = u.length; c--;)(d = u[c]) && (y[h[c]] = !(v[h[c]] = d));
                if (i) {
                    if (o || e) {
                        if (o) {
        ...
        function y(e) {
            for (var t, n, i, r = e.length, o = T.relative[e[0].type], a = o || T.relative[" "], s = o ? 1 : 0, l = f(function(e) {
                ...
                if (n = T.relative[e[s].type]) c = [f(g(c), n)];
                else {
        ...
        function x(e, t, n, i) {
            var r, o, a, s, l, u = p(e);
            if (!i && 1 === u.length) {
                if (o = u[0] = u[0].slice(0), o.length > 2 && "ID" === (a = o[0]).type && k.getById && 9 === t.nodeType && $ && T.relative[o[1].type]) {
                    if (t = (T.find.ID(a.matches[0].replace(xt, _t), t) || [])[0], !t) return n;
                    e = e.slice(o.shift().value.length)
                }
                for (r = ft.needsContext.test(e) ? 0 : o.length; r-- && (a = o[r], !T.relative[s = a.type]);)
                    if ((l = T.find[s]) && (i = l(a.matches[0].replace(xt, _t), bt.test(o[0].type) && c(t.parentNode) || t))) {
                        if (o.splice(r, 1), e = i.length && h(o), !e) return Z.apply(n, i), n;
                        break
                    }
            }
            return C(e, u)(i, t, !$, n, bt.test(e) && c(t.parentNode) || t), n
        }
        var _, k, T, E, D, C, S, N, M, A, P, O, $, R, j, I, F, q = "sizzle" + -new Date,
            V = e.document,
            L = 0,
            U = 0,
            B = n(),
        ...
        k = t.support = {}, D = t.isXML = function(e) {
            var t = e && (e.ownerDocument || e).documentElement;
            return t ? "HTML" !== t.nodeName : !1
        }, A = t.setDocument = function(e) {
            var t, n = e ? e.ownerDocument || e : V,
                i = n.defaultView;
            return n !== P && 9 === n.nodeType && n.documentElement ? (P = n, O = n.documentElement, $ = !D(n), i && i !== i.top && (i.addEventListener ? i.addEventListener("unload", function() {
                A()
            ...
            }, j = [], R = [], (k.qsa = vt.test(n.querySelectorAll)) && (r(function(e) {
            ...
            })), (k.matchesSelector = vt.test(I = O.webkitMatchesSelector || O.mozMatchesSelector || O.oMatchesSelector || O.msMatchesSelector)) && r(function(e) {
                k.disconnectedMatch = I.call(e, "div"), I.call(e, "[s!='']:x"), j.push("!=", st)
            }), R = R.length && new RegExp(R.join("|")), j = j.length && new RegExp(j.join("|")), t = vt.test(O.compareDocumentPosition), F = t || vt.test(O.contains) ? function(e, t) {
                ...
                return i ? i : (i = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1, 1 & i || !k.sortDetached && t.compareDocumentPosition(e) === i ? e === n || e.ownerDocument === V && F(V, e) ? -1 : t === n || t.ownerDocument === V && F(V, t) ? 1 : N ? tt.call(N, e) - tt.call(N, t) : 0 : 4 & i ? -1 : 1)
            } : function(e, t) {
                if (e === t) return M = !0, 0;
                var i, r = 0,
                    o = e.parentNode,
            ...
            if ((e.ownerDocument || e) !== P && A(e), n = n.replace(dt, "='$1']"), !(!k.matchesSelector || !$ || j && j.test(n) || R && R.test(n))) try {
                var i = I.call(e, n);
            ...
            var n = T.attrHandle[t.toLowerCase()],
                i = n && K.call(T.attrHandle, t.toLowerCase()) ? n(e, t, !$) : void 0;
            ...
            filter: {
                ...
                CHILD: function(e, t, n, i, r) {
                    ...
                    return 1 === i && 0 === r ? function(e) {
                        ...
                        var u, c, d, p, h, f, g = o !== a ? "nextSibling" : "previousSibling",
                            m = t.parentNode,
                        ...
                        if (m) {
                            ...
                            if (f = [a ? m.firstChild : m.lastChild], a && y) {
                                for (c = m[q] || (m[q] = {}), u = c[e] || [], h = u[0] === L && u[1], p = u[0] === L && u[2], d = h && m.childNodes[h]; d = ++h && d && d[g] || (p = h = 0) || f.pop();)
                                    if (1 === d.nodeType && ++p && d === t) {
                                        c[e] = [L, h, p];
                                        break
                                    }
                            } else if (y && (u = (t[q] || (t[q] = {}))[e]) && u[0] === L) p = u[1];
                            else
                                for (;
                                    (d = ++h && d && d[g] || (p = h = 0) || f.pop()) && ((s ? d.nodeName.toLowerCase() !== v : 1 !== d.nodeType) || !++p || (y && ((d[q] || (d[q] = {}))[e] = [L, p]), d !== t)););
            ...
            pseudos: {
                ...
                lang: i(function(e) {
                    return ht.test(e || "") || t.error("unsupported lang: " + e), e = e.replace(xt, _t).toLowerCase(),
                        function(t) {
                            var n;
                            do
        ...
        return d.prototype = T.filters = T.pseudos, T.setFilters = new d, C = t.compile = function(e, t) {
            var n, i = [],
                r = [],
                o = W[e + " "];
            if (!o) {
            ...
            return o
        }, k.sortStable = q.split("").sort(z).join("") === q, k.detectDuplicates = !!M, A(), k.sortDetached = r(function(e) {
    ...
    et.extend({
        ...
        et.fn[e] = function(n, i) {
            ...
            return "Until" !== e.slice(-5) && (i = n), i && "string" == typeof i && (r = et.filter(i, r)), this.length > 1 && (pt[e] || et.unique(r), dt.test(e) && r.reverse()), this.pushStack(r)
        }
    });
    var ht = /\S+/g,
        ft = {};
    ...
    et.acceptData = function(e) {
        ...
        remove: function(e, t) {
            ...
            if (void 0 === t) this.cache[o] = {};
                ...
                et.isArray(t) ? i = t.concat(t.map(et.camelCase)) : (r = et.camelCase(t), t in a ? i = [t, r] : (i = r, i = i in a ? [i] : i.match(ht) || [])), n = i.length;
                for (; n--;) delete a[i[n]]
            }
        },
        hasData: function(e) {
    ...
    et.event = {
        ...
        add: function(e, t, n, i, r) {
            var o, a, s, l, u, c, d, p, h, f, g, m = vt.get(e);
            if (m)
                for (n.handler && (o = n, n = o.handler, r = o.selector), n.guid || (n.guid = et.guid++), (l = m.events) || (l = m.events = {}), (a = m.handle) || (a = m.handle = function(t) {
                ...
                }), t = (t || "").match(ht) || [""], u = t.length; u--;) s = Nt.exec(t[u]) || [], h = g = s[1], f = (s[2] || "").split(".").sort(), h && (d = et.event.special[h] || {}, h = (r ? d.delegateType : d.bindType) || h, d = et.event.special[h] || {}, c = et.extend({
                    type: h,
                    origType: g,
                    data: i,
                    handler: n,
                    ...
                    namespace: f.join(".")
                }, o), (p = l[h]) || (p = l[h] = [], p.delegateCount = 0, d.setup && d.setup.call(e, i, f, a) !== !1 || e.addEventListener && e.addEventListener(h, a, !1)), d.add && (d.add.call(e, c), c.handler.guid || (c.handler.guid = n.guid)), r ? p.splice(p.delegateCount++, 0, c) : p.push(c), et.event.global[h] = !0)
        },
        remove: function(e, t, n, i, r) {
            var o, a, s, l, u, c, d, p, h, f, g, m = vt.hasData(e) && vt.get(e);
            if (m && (l = m.events)) {
                for (t = (t || "").match(ht) || [""], u = t.length; u--;)
                    if (s = Nt.exec(t[u]) || [], h = g = s[1], f = (s[2] || "").split(".").sort(), h) {
                        for (d = et.event.special[h] || {}, h = (i ? d.delegateType : d.bindType) || h, p = l[h] || [], s = s[2] && new RegExp("(^|\\.)" + f.join("\\.(?:.*\\.|)") + "(\\.|$)"), a = o = p.length; o--;) c = p[o], !r && g !== c.origType || n && n.guid !== c.guid || s && !s.test(c.namespace) || i && i !== c.selector && ("**" !== i || !c.selector) || (p.splice(o, 1), c.selector && p.delegateCount--, d.remove && d.remove.call(e, c));
                        a && !p.length && (d.teardown && d.teardown.call(e, f, m.handle) !== !1 || et.removeEvent(e, h, m.handle), delete l[h])
                    } else
                        for (h in l) et.event.remove(e, h + t[u], n, i, !0);
                et.isEmptyObject(l) && (delete m.handle, vt.remove(e, "events"))
            }
        },
        trigger: function(t, n, i, r) {
            var o, a, s, l, u, c, d, p = [i || G],
                h = K.call(t, "type") ? t.type : t,
                f = K.call(t, "namespace") ? t.namespace.split(".") : [];
            if (a = s = i = i || G, 3 !== i.nodeType && 8 !== i.nodeType && !St.test(h + et.event.triggered) && (h.indexOf(".") >= 0 && (f = h.split("."), h = f.shift(), f.sort()), u = h.indexOf(":") < 0 && "on" + h, t = t[et.expando] ? t : new et.Event(h, "object" == typeof t && t), t.isTrigger = r ? 2 : 3, t.namespace = f.join("."), t.namespace_re = t.namespace ? new RegExp("(^|\\.)" + f.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = i), n = null == n ? [t] : et.makeArray(n, [t]), d = et.event.special[h] || {}, r || !d.trigger || d.trigger.apply(i, n) !== !1)) {
                ...
                for (o = 0;
                    (a = p[o++]) && !t.isPropagationStopped();) t.type = o > 1 ? l : d.bindType || h, c = (vt.get(a, "events") || {})[t.type] && vt.get(a, "handle"), c && c.apply(a, n), c = u && a[u], c && c.apply && et.acceptData(a) && (t.result = c.apply(a, n), t.result === !1 && t.preventDefault());
                return t.type = h, r || t.isDefaultPrevented() || d._default && d._default.apply(p.pop(), n) !== !1 || !et.acceptData(i) || u && et.isFunction(i[h]) && !et.isWindow(i) && (s = i[u], s && (i[u] = null), et.event.triggered = h, i[h](), et.event.triggered = void 0, s && (i[u] = s)), t.result
            }
        },
        dispatch: function(e) {
            e = et.event.fix(e);
    ...
    Ft.optgroup = Ft.option, Ft.tbody = Ft.tfoot = Ft.colgroup = Ft.caption = Ft.thead, Ft.th = Ft.td, et.extend({
        clone: function(e, t, n) {
        ...
        buildFragment: function(e, t, n, i) {
            for (var r, o, a, s, l, u, c = t.createDocumentFragment(), d = [], p = 0, h = e.length; h > p; p++)
                if (r = e[p], r || 0 === r)
                    if ("object" === et.type(r)) et.merge(d, r.nodeType ? [r] : r);
                    else if (Pt.test(r)) {
                for (o = o || c.appendChild(t.createElement("div")), a = (At.exec(r) || ["", ""])[1].toLowerCase(), s = Ft[a] || Ft._default, o.innerHTML = s[1] + r.replace(Mt, "<$1></$2>") + s[2], u = s[0]; u--;) o = o.lastChild;
            ...
            for (c.textContent = "", p = 0; r = d[p++];)
                if ((!i || -1 === et.inArray(r, i)) && (l = et.contains(r.ownerDocument, r), o = v(c.appendChild(r), "script"), l && g(o), n))
                    for (u = 0; r = o[u++];) Rt.test(r.type || "") && n.push(r);
            return c
        },
        ...
        html: function(e) {
            return mt(this, function(e) {
                ...
                if ("string" == typeof e && !Ot.test(e) && !Ft[(At.exec(e) || ["", ""])[1].toLowerCase()]) {
                    e = e.replace(Mt, "<$1></$2>");
                    try {
        ...
        domManip: function(e, t) {
            ...
            var n, i, r, o, a, s, l = 0,
                ...
                p = e[0],
                g = et.isFunction(p);
            if (g || u > 1 && "string" == typeof p && !Q.checkClone && $t.test(p)) return this.each(function(n) {
                var i = c.eq(n);
            ...
            if (u && (n = et.buildFragment(e, this[0].ownerDocument, !1, this), i = n.firstChild, 1 === n.childNodes.length && (n = i), i)) {
                for (r = et.map(v(n, "script"), h), o = r.length; u > l; l++) a = n, l !== d && (a = et.clone(a, !0, !0), o && et.merge(r, v(a, "script"))), t.call(this[l], a, l);
                if (o)
                    for (s = r[r.length - 1].ownerDocument, et.map(r, f), l = 0; o > l; l++) a = r[l], Rt.test(a.type || "") && !vt.access(a, "globalEval") && et.contains(s, a) && (a.src ? et._evalUrl && et._evalUrl(a.src) : et.globalEval(a.textContent.replace(It, "")))
            }
            return this
        }
    }), et.each({
    ...
    et.extend({
        ...
        style: function(e, t, n, i) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                var r, o, a, s = et.camelCase(t),
                    l = e.style;
                return t = et.cssProps[s] || (et.cssProps[s] = k(l, s)), a = et.cssHooks[t] || et.cssHooks[s], void 0 === n ? a && "get" in a && void 0 !== (r = a.get(e, !1, i)) ? r : l[t] : (o = typeof n, "string" === o && (r = zt.exec(n)) && (n = (r[1] + 1) * r[2] + parseFloat(et.css(e, t)), o = "number"), null != n && n === n && ("number" !== o || et.cssNumber[s] || (n += "px"), Q.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (l[t] = "inherit"), a && "set" in a && void 0 === (n = a.set(e, n, i)) || (l[t] = "", l[t] = n)), void 0)
            }
        },
        css: function(e, t, n, i) {
            var r, o, a, s = et.camelCase(t);
            return t = et.cssProps[s] || (et.cssProps[s] = k(e.style, s)), a = et.cssHooks[t] || et.cssHooks[s], a && "get" in a && (r = a.get(e, !0, n)), void 0 === r && (r = x(e, t, i)), "normal" === r && t in Yt && (r = Yt[t]), "" === n || n ? (o = parseFloat(r), n === !0 || et.isNumeric(o) ? o || 0 : r) : r
        }
    ...
    }), et.cssHooks.marginRight = _(Q.reliableMarginRight, function(e, t) {
        return t ? et.swap(e, {
        ...
        et.cssHooks[e + t] = {
            expand: function(n) {
                for (var i = 0, r = {}, o = "string" == typeof n ? n.split(" ") : [n]; 4 > i; i++) r[e + _t[i] + t] = o[i] || o[i - 2] || o[0];
                return r
            }
        }, Lt.test(e) || (et.cssHooks[e + t].set = T)
    }), et.fn.extend({
        css: function(e, t) {
    ...
    et.fn.extend({
        ...
        toggleClass: function(e, t) {
            ...
            return "boolean" == typeof t && "string" === n ? t ? this.addClass(e) : this.removeClass(e) : this.each(et.isFunction(e) ? function(n) {
                ...
                if ("string" === n)
                    for (var t, i = 0, r = et(this), o = e.match(ht) || []; t = o[i++];) r.hasClass(t) ? r.removeClass(t) : r.addClass(t);
    ...
    pn = wn.exec(hn.toLowerCase()) || [], et.extend({
        active: 0,
        lastModified: {},
        etag: {},
        ajaxSettings: {
        ...
        ajaxSetup: function(e, t) {
            return t ? I(I(e, et.ajaxSettings), t) : I(et.ajaxSettings, e)
        },
        ajaxPrefilter: R(xn),
        ajaxTransport: R(_n),
        ajax: function(e, t) {
            function n(e, t, n, a) {
                var l, c, v, y, w, _ = t;
                2 !== b && (b = 2, s && clearTimeout(s), i = void 0, o = a || "", x.readyState = e > 0 ? 4 : 0, l = e >= 200 && 300 > e || 304 === e, n && (y = F(d, x, n)), y = q(d, y, x, l), l ? (d.ifModified && (w = x.getResponseHeader("Last-Modified"), w && (et.lastModified[r] = w), w = x.getResponseHeader("etag"), w && (et.etag[r] = w)), 204 === e || "HEAD" === d.type ? _ = "nocontent" : 304 === e ? _ = "notmodified" : (_ = y.state, c = y.data, v = y.error, l = !v)) : (v = _, (e || !_) && (_ = "error", 0 > e && (e = 0))), x.status = e, x.statusText = (t || _) + "", l ? f.resolveWith(p, [c, _, x]) : f.rejectWith(p, [x, _, v]), x.statusCode(m), m = void 0, u && h.trigger(l ? "ajaxSuccess" : "ajaxError", [x, d, l ? c : v]), g.fireWith(p, [x, _]), u && (h.trigger("ajaxComplete", [x, d]), --et.active || et.event.trigger("ajaxStop")))
            }
            ...
            if (f.promise(x).complete = g.add, x.success = x.done, x.error = x.fail, d.url = ((e || d.url || hn) + "").replace(fn, "").replace(bn, pn[1] + "//"), d.type = t.method || t.type || d.method || d.type, d.dataTypes = et.trim(d.dataType || "*").toLowerCase().match(ht) || [""], null == d.crossDomain && (l = wn.exec(d.url.toLowerCase()), d.crossDomain = !(!l || l[1] === pn[1] && l[2] === pn[2] && (l[3] || ("http:" === l[1] ? "80" : "443")) === (pn[3] || ("http:" === pn[1] ? "80" : "443")))), d.data && d.processData && "string" != typeof d.data && (d.data = et.param(d.data, d.traditional)), j(xn, d, t, x), 2 === b) return x;
            u = d.global, u && 0 === et.active++ && et.event.trigger("ajaxStart"), d.type = d.type.toUpperCase(), d.hasContent = !yn.test(d.type), r = d.url, d.hasContent || (d.data && (r = d.url += (dn.test(r) ? "&" : "?") + d.data, delete d.data), d.cache === !1 && (d.url = gn.test(r) ? r.replace(gn, "$1_=" + cn++) : r + (dn.test(r) ? "&" : "?") + "_=" + cn++)), d.ifModified && (et.lastModified[r] && x.setRequestHeader("If-Modified-Since", et.lastModified[r]), et.etag[r] && x.setRequestHeader("If-None-Match", et.etag[r])), (d.data && d.hasContent && d.contentType !== !1 || t.contentType) && x.setRequestHeader("Content-Type", d.contentType), x.setRequestHeader("Accept", d.dataTypes[0] && d.accepts[d.dataTypes[0]] ? d.accepts[d.dataTypes[0]] + ("*" !== d.dataTypes[0] ? ", " + kn + "; q=0.01" : "") : d.accepts["*"]);
    ...
    et.param = function(e, t) {
        ...
        serializeArray: function() {
            return this.map(function() {
                ...
                var e = this.type;
                return this.name && !et(this).is(":disabled") && Nn.test(this.nodeName) && !Sn.test(e) && (this.checked || !Tt.test(e))
            }).map(function(e, t) {
                var n = et(this).val();
    ...
    et.ajaxSetup({
        ...
        jsonpCallback: function() {
            var e = $n.pop() || et.expando + "_" + cn++;
            return this[e] = !0, e
        }
    }), et.ajaxPrefilter("json jsonp", function(t, n, i) {
        var r, o, a, s = t.jsonp !== !1 && (Rn.test(t.url) ? "url" : "string" == typeof t.data && !(t.contentType || "").indexOf("application/x-www-form-urlencoded") && Rn.test(t.data) && "data");
        return s || "jsonp" === t.dataTypes[0] ? (r = t.jsonpCallback = et.isFunction(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback, s ? t[s] = t[s].replace(Rn, "$1" + r) : t.jsonp !== !1 && (t.url += (dn.test(t.url) ? "&" : "?") + t.jsonp + "=" + r), t.converters["script json"] = function() {
            return a || et.error(r + " was not called"), a[0]
        }, t.dataTypes[0] = "json", o = e[r], e[r] = function() {
            a = arguments
        }, i.always(function() {
            e[r] = o, t[r] && (t.jsonpCallback = n.jsonpCallback, $n.push(r)), a && et.isFunction(o) && o(a[0]), a = o = void 0
        }), "script") : void 0
    ...
    et.offset = {
        setOffset: function(e, t, n) {
            var i, r, o, a, s, l, u, c = et.css(e, "position"),
                d = et(e),
                p = {};
            "static" === c && (e.style.position = "relative"), s = d.offset(), o = et.css(e, "top"), l = et.css(e, "left"), u = ("absolute" === c || "fixed" === c) && (o + l).indexOf("auto") > -1, u ? (i = d.position(), a = i.top, r = i.left) : (a = parseFloat(o) || 0, r = parseFloat(l) || 0), et.isFunction(t) && (t = t.call(e, n, s)), null != t.top && (p.top = t.top - s.top + a), null != t.left && (p.left = t.left - s.left + r), "using" in t ? t.using.call(e, p) : d.css(p)
        }
    }, et.fn.extend({
        offset: function(e) {
            ...
            var t, n, i = this[0],
                ...
                o = i && i.ownerDocument;
            if (o) return t = o.documentElement, et.contains(t, i) ? (typeof i.getBoundingClientRect !== Et && (r = i.getBoundingClientRect()), n = L(o), {
        ...
        offsetParent: function() {
            return this.map(function() {
                for (var e = this.offsetParent || In; e && !et.nodeName(e, "html") && "static" === et.css(e, "position");) e = e.offsetParent;
                return e || In
            })
        }
    }), et.each({
        ...
        et.cssHooks[t] = _(Q.pixelPosition, function(e, n) {
    ...
    return et.noConflict = function(t) {
        return e.$ === et && (e.$ = qn), t && e.jQuery === et && (e.jQuery = Fn), et
    ...
    return n.prototype.getInstanceID = function() {
        ...
        var l, u, c, d, p, h, f, g, m, v, y, b, w;
        if (s = s || !1, r = r || "any", a = a || 0, i = i.trim(), p = new n(this.getStr(!1, !1)).$, h = p[0], this.INSTANCE.test(i))
            for (f = i.match(this.INSTANCE), l = 0; l < f.length; l++) g = f[l].match(/[\'|\"]([^\'']+)[\'|\"]/)[1], i = i.replace(f[l], '/node()/instance[@id="' + g + '"]'), this.$.find(":first>instance#" + g).clone().appendTo(p.find(":first"));
        "undefined" != typeof o && null !== o ? (d = p.xfind(o).eq(a)[0], b = this.node(o).get(), b.length > 1 && (i = this.makeBugCompliant(i, o, a))) : d = h, v = {
            0: ["any", "ANY_TYPE"],
        ...
        if (i = i.replace(/&lt;/g, "<"), i = i.replace(/&gt;/g, ">"), i = i.replace(/&quot;/g, '"'), s && "undefined" != typeof h.evaluate && !this.OPENROSA.test(i)) try {
            y = h.evaluate(i, d, null, m, null)
        } catch (x) {
        ...
        if (!y) try {
            e.bindDomLevel3XPath(h), y = h.evaluate(i, d, null, m, null)
        } catch (x) {
    ...
    return t = {
        ...
        load: function(e, n, i, r) {
            ...
            var o = t.parseName(e),
                ...
                s = n.toUrl(a),
                l = f.useXhr || t.useXhr;
            return 0 === s.indexOf("empty:") ? void i() : void(!u || l(s, c, d, p) ? t.get(s, function(n) {
    ...
    var d, p, h = "2.7.1",
        ...
        j = {}.hasOwnProperty;
    p = o(j, "undefined") || o(j.call, "undefined") ? function(e, t) {
        ...
        var n;
        return "ontouchstart" in e || e.DocumentTouch && t instanceof DocumentTouch ? n = !0 : O(["@media (", k.join("touch-enabled),("), v, ")", "{#modernizr{top:9px;position:absolute}}"].join(""), function(e) {
            n = 9 === e.offsetTop
        }), n
        ...
        return i((e + "-webkit- ".split(" ").join(t + e) + k.join(n + e)).slice(0, -e.length)), a(b.backgroundImage, "gradient")
        ...
        return !!t.createElementNS && /SVGAnimate/.test(_.call(t.createElementNS(C.svg, "animate")))
    }, S.svgclippaths = function() {
        return !!t.createElementNS && /SVGClipPath/.test(_.call(t.createElementNS(C.svg, "clipPath")))
    };
    for (var I in S) p(S, I) && (d = I.toLowerCase(), f[d] = S[I](), A.push((f[d] ? "" : "no-") + d));
    return f.input || c(), f.addTest = function(e, t) {
        ...
        return f
    }, i(""), y = w = null, f._version = h, f._prefixes = k, f._domPrefixes = D, f._cssomPrefixes = E, f.mq = $, f.hasEvent = R, f.testProp = function(e) {
        return s([e])
    ...
    function s(e, t) {
        t.cache || (t.cache = {}, t.createElem = e.createElement, t.createFrag = e.createDocumentFragment, t.frag = t.createFrag()), e.createElement = function(n) {
            return _.shivMethods ? o(n, e, t) : t.createElem(n)
    ...
    function l(e) {
        e || (e = t);
        var i = r(e);
        return !_.shivCSS || f || i.hasCSS || (i.hasCSS = !!n(e, "article,aside,figcaption,figure,footer,header,hgroup,nav,section{display:block}mark{background:#FF0;color:#000}")), g || s(e, i), e
    }
    ...
    function c(e) {
        for (var t, n = e.attributes, i = n.length, r = e.ownerDocument.createElement(T + ":" + e.nodeName); i--;) t = n[i], t.specified && r.setAttribute(t.nodeName, t.nodeValue);
        return r.style.cssText = e.style.cssText, r
    }

    function d(e) {
        for (var t, n = e.split("{"), r = n.length, o = RegExp("(^|[\\s,>+~])(" + i().join("|") + ")(?=[[\\s,>+~#.:]|$)", "gi"), a = "$1" + T + "\\:$2"; r--;) t = n[r] = n[r].split("}"), t[t.length - 1] = t[t.length - 1].replace(o, a), n[r] = t.join("}");
        return n.join("{")
    }
    ...
    function h(e) {
        ...
        var i, o, a = r(e),
            s = e.namespaces,
            l = e.parentWindow;
        return !E || e.printShived ? e : ("undefined" == typeof s[T] && s.add(T), l.attachEvent("onbeforeprint", function() {
            t();
            for (var r, a, s, l = e.styleSheets, c = [], p = l.length, h = Array(p); p--;) h[p] = l[p];
            for (; s = h.pop();)
    ...
    _.type += " print", _.shivPrint = h, h(t)
    ...
    function i(e) {
        p = n("form.or"), e = e || p, f ? u(e) : r(function() {
            u(e)
        })
    }
    ...
    function r(e) {
        require(g.widgets, function() {
            ...
            require(n, function() {
                for (var t = 0; t < arguments.length; t++) h.push(JSON.parse(arguments[t]));
                f = !0, e()
            })
        })
    }
    ...
    function a(e) {
        for (var t, n, i = 0; i < h.length; i++) t = h[i], t.name && (n = o(e, t.selector), n[t.name]("enable"))
    }

    function s(e) {
        for (var t, n, i = 0; i < h.length; i++) t = h[i], t.name && (n = o(e, t.selector), n[t.name]("disable"))
    }

    function l(e) {
        for (var t, n, i = 0; i < h.length; i++) t = h[i], t.name && (n = o(e, t.selector), n[t.name]("destroy"))
    }

    function u(e) {
        for (var n, i, r = 0; r < h.length; r++) n = h[r], n.options = n.options || {}, n.options.touch = t.touch, n.name && (n.selector || null === n.selector ? (i = o(e, n.selector), i[n.name](n.options), c(n, i), d(n, i)) : console.error("widget configuration has no acceptable selector property", n))
    }

    function c(e, t) {
        t.length > 0 && p.on("changelanguage", function() {
            t[e.name]("update")
        })
    }

    function d(e, t) {
        t.length > 0 && "select" === t.prop("nodeName").toLowerCase() && p.on("changeoption", "select", function() {
    ...
    t.DEFAULTS = {
        ...
        if (this.hasContent() && this.enabled) {
            ...
            if (a) {
                ...
                r = "bottom" == r && s.top + s.height + u - p > f ? "top" : "top" == r && s.top - p - u < 0 ? "bottom" : "right" == r && s.right + l > h ? "left" : "left" == r && s.left - l < g ? "right" : r, i.removeClass(d).addClass(r)
            }
    ...
    function(e) {
        ...
        function n(t, n) {
            function D(t) {
                if (!(st() || e(t.target).closest(n.excludedElements, Ut).length > 0)) {
                    var i, r = t.originalEvent ? t.originalEvent : t,
                        o = T ? r.touches[0] : r;
                    return Bt = w, T ? Ht = r.touches.length : t.preventDefault(), Ot = 0, $t = null, Vt = null, Rt = 0, jt = 0, It = 0, Ft = 1, qt = 0, Wt = pt(), Lt = gt(), ot(), !T || Ht === n.fingers || n.fingers === y || L() ? (ut(0, o), zt = Tt(), 2 == Ht && (ut(1, r.touches[1]), jt = It = yt(Wt[0].start, Wt[1].start)), (n.swipeStatus || n.pinchStatus) && (i = O(r, Bt))) : i = !1, i === !1 ? (Bt = k, O(r, Bt), i) : (lt(!0), null)
                }
            }
            ...
            function C(e) {
                ...
                if (Bt !== _ && Bt !== k && !at()) {
                    var i, r = T ? t.touches[0] : t,
                        o = ct(r);
                    if (Xt = Tt(), T && (Ht = t.touches.length), Bt = x, 2 == Ht && (0 == jt ? (ut(1, t.touches[1]), jt = It = yt(Wt[0].start, Wt[1].start)) : (ct(t.touches[1]), It = yt(Wt[0].end, Wt[1].end), Vt = wt(Wt[0].end, Wt[1].end)), Ft = bt(jt, It), qt = Math.abs(jt - It)), Ht === n.fingers || n.fingers === y || !T || L()) {
                        if ($t = kt(o.start, o.end), q(e, $t), Ot = xt(o.start, o.end), Rt = vt(), ht($t, Ot), (n.swipeStatus || n.pinchStatus) && (i = O(t, Bt)), !n.triggerOnTouchEnd || n.triggerOnTouchLeave) {
                            var a = !0;
                            if (n.triggerOnTouchLeave) {
                                var s = Et(this);
                                a = Dt(o.end, s)
                            }!n.triggerOnTouchEnd && a ? Bt = P(x) : n.triggerOnTouchLeave && !a && (Bt = P(_)), (Bt == k || Bt == _) && O(t, Bt)
                        }
                    } else Bt = k, O(t, Bt);
                    i === !1 && (Bt = k, O(t, Bt))
                }
            ...
            function S(e) {
                ...
                return T && t.touches.length > 0 ? (rt(), !0) : (at() && (Ht = Kt), e.preventDefault(), Xt = Tt(), Rt = vt(), j() ? (Bt = k, O(t, Bt)) : n.triggerOnTouchEnd || 0 == n.triggerOnTouchEnd && Bt === x ? (Bt = _, O(t, Bt)) : !n.triggerOnTouchEnd && Y() ? (Bt = _, $(t, Bt, h)) : Bt === x && (Bt = k, O(t, Bt)), lt(!1), null)
            }

            function N() {
                Ht = 0, Xt = 0, zt = 0, jt = 0, It = 0, Ft = 1, ot(), lt(!1)
            }

            function M(e) {
                var t = e.originalEvent;
                n.triggerOnTouchLeave && (Bt = P(_), O(t, Bt))
            }
            ...
            function P(e) {
                var t = e,
                    ...
                    r = R(),
                    o = j();
                return !i || o ? t = k : !r || e != x || n.triggerOnTouchEnd && !n.triggerOnTouchLeave ? !r && e == _ && n.triggerOnTouchLeave && (t = k) : t = _, t
            }

            function O(e, t) {
                var n = void 0;
                return W() || H() ? n = $(e, t, d) : (U() || L()) && n !== !1 && (n = $(e, t, p)), nt() && n !== !1 ? n = $(e, t, f) : it() && n !== !1 ? n = $(e, t, g) : tt() && n !== !1 && (n = $(e, t, h)), t === k && N(e), t === _ && (T ? 0 == e.touches.length && N(e) : N(e)), n
            }

            function $(t, u, c) {
                var m = void 0;
                if (c == d) {
                    if (Ut.trigger("swipeStatus", [u, $t || null, Ot || 0, Rt || 0, Ht]), n.swipeStatus && (m = n.swipeStatus.call(Ut, t, u, $t || null, Ot || 0, Rt || 0, Ht), m === !1)) return !1;
                    if (u == _ && B()) {
                        if (Ut.trigger("swipe", [$t, Ot, Rt, Ht]), n.swipe && (m = n.swipe.call(Ut, t, $t, Ot, Rt, Ht), m === !1)) return !1;
                        switch ($t) {
                            case i:
                                Ut.trigger("swipeLeft", [$t, Ot, Rt, Ht]), n.swipeLeft && (m = n.swipeLeft.call(Ut, t, $t, Ot, Rt, Ht));
                                break;
                            case r:
                                Ut.trigger("swipeRight", [$t, Ot, Rt, Ht]), n.swipeRight && (m = n.swipeRight.call(Ut, t, $t, Ot, Rt, Ht));
                                break;
                            case o:
                                Ut.trigger("swipeUp", [$t, Ot, Rt, Ht]), n.swipeUp && (m = n.swipeUp.call(Ut, t, $t, Ot, Rt, Ht));
                                break;
                            case a:
                                Ut.trigger("swipeDown", [$t, Ot, Rt, Ht]), n.swipeDown && (m = n.swipeDown.call(Ut, t, $t, Ot, Rt, Ht))
                        }
                    }
                }
                if (c == p) {
                    if (Ut.trigger("pinchStatus", [u, Vt || null, qt || 0, Rt || 0, Ht, Ft]), n.pinchStatus && (m = n.pinchStatus.call(Ut, t, u, Vt || null, qt || 0, Rt || 0, Ht, Ft), m === !1)) return !1;
                    if (u == _ && V()) switch (Vt) {
                        case s:
                            Ut.trigger("pinchIn", [Vt || null, qt || 0, Rt || 0, Ht, Ft]), n.pinchIn && (m = n.pinchIn.call(Ut, t, Vt || null, qt || 0, Rt || 0, Ht, Ft));
                            break;
                        case l:
                            Ut.trigger("pinchOut", [Vt || null, qt || 0, Rt || 0, Ht, Ft]), n.pinchOut && (m = n.pinchOut.call(Ut, t, Vt || null, qt || 0, Rt || 0, Ht, Ft))
                    }
                }
                return c == h ? (u === k || u === _) && (clearTimeout(Qt), K() && !G() ? (Jt = Tt(), Qt = setTimeout(e.proxy(function() {
                    Jt = null, Ut.trigger("tap", [t.target]), n.tap && (m = n.tap.call(Ut, t, t.target))
                }, this), n.doubleTapThreshold)) : (Jt = null, Ut.trigger("tap", [t.target]), n.tap && (m = n.tap.call(Ut, t, t.target)))) : c == f ? (u === k || u === _) && (clearTimeout(Qt), Jt = null, Ut.trigger("doubletap", [t.target]), n.doubleTap && (m = n.doubleTap.call(Ut, t, t.target))) : c == g && (u === k || u === _) && (clearTimeout(Qt), Jt = null, Ut.trigger("longtap", [t.target]), n.longTap && (m = n.longTap.call(Ut, t, t.target))), m
            }
            ...
            function j() {
                var e = !1;
                return null !== n.cancelThreshold && null !== $t && (e = ft($t) - Ot >= n.cancelThreshold), e
            }
            ...
            function F() {
                var e;
                return e = n.maxTimeThreshold ? Rt >= n.maxTimeThreshold ? !1 : !0 : !0
            }
            ...
            function z() {
                return Ht === n.fingers || n.fingers === y || !T
            }
            ...
            function Z() {
                return !(1 !== Ht && T || !isNaN(Ot) && 0 !== Ot)
            }

            function et() {
                return Rt > n.longTapThreshold && b > Ot
            }
            ...
            function rt() {
                Yt = Tt(), Kt = event.touches.length + 1
            }
            ...
            function st() {
                return !(Ut.data(E + "_intouch") !== !0)
            }

            function lt(e) {
                e === !0 ? (Ut.bind(Nt, C), Ut.bind(Mt, S), At && Ut.bind(At, M)) : (Ut.unbind(Nt, C, !1), Ut.unbind(Mt, S, !1), At && Ut.unbind(At, M, !1)), Ut.data(E + "_intouch", e === !0)
            }
            ...
            var Ct = T || !n.fallbackToMouseEvents,
        ...
        function i(i, r, o) {
            function a(e) {
                c = n(e), this.$ = c, this.$nonRepeats = {}
            }
            var s, l, u, c, d, p, h, f = [];
            this.init = function() {
                return d = n(i).clone().appendTo("<original></original>"), s = new e(r), u = new a(i), f = f.concat(s.init()), "undefined" != typeof o && o && o.length > 0 && (l = new e(o), f = f.concat(l.init()), this.load(l)), p = n(i).find(".or-repeat").length > 0, u.init(), f.length > 0 && console.error("loadErrors: ", f), window.scrollTo && window.scrollTo(0, 0), f
            }, this.ex = function(e, t, n, i) {
                return s.evaluate(e, t, n, i)
                ...
                return u.$.data("base64rsapublickey")
            }, this.getDataStr = function(e, t, n) {
                return s.getStr(e, t, n)
            }, this.getRecordName = function() {
                return u.recordName.get()
            }, this.setRecordName = function(e) {
                return u.recordName.set(e)
            }, this.setEditStatus = function(e) {
                return u.editStatus.set(e)
            }, this.getEditStatus = function() {
                return u.editStatus.get()
            }, this.getSurveyName = function() {
                return c.find("#form-title").text()
            }, this.resetView = function() {
                n("#form-languages").remove(), c.replaceWith(d)
            }, this.resetHTML = this.resetView, this.validate = function() {
                return u.validateAll()
            }, this.isValid = function() {
                return u.isValid()
            }, this.load = function(e) {
                var t, i, r, o, a, l, d, p, h, g, m, v = {
                    noTemplate: !0,
                    noEmpty: !0
                };
                if (t = e.node(null, null, v).get(), s.node(null, null, v).get().each(function() {
                    n(this).text("")
                }), t.each(function() {
                    var t, g = n(this).prop("nodeName");
                    o = n(this).getXPath("instance"), i = e.node(o).get().index(n(this)), a = n(this).text(), d = c.find('[name="' + o + '"]').eq(0), r = d.length > 0 ? u.input.getXmlType(d) : "string", r = "binary" === r ? "string" : r, l = s.node(o, i);
                    try {
                        p = l.get()
                    } catch (m) {
                        return console.error(m), t = m.message || "unknown error", void f.push(t + " when retrieving " + o)
                    }
                    if (p.length > 1) console.error("Found multiple nodes with path: " + o + " and index: " + i);
                    else if (1 === p.length) l.setVal(a, null, r);
                    else if (s.node(o, 0, {
                        noTemplate: !1
                        ...
                        for (var v = 0; i > v; v++) s.cloneTemplate(h.getXPath("instance"), v);
                        l = s.node(o, i), 1 === l.get().length ? l.setVal(a, null, r) : (m = "Error occured trying to clone template node to set the repeat value of the instance to be edited.", console.error(m), f.push(m))
                    } else 1 === n(this).parent("meta").length && 1 === s.node(n(this).parent("meta").getXPath("instance"), 0).get().length ? 0 === s.node(":first > meta > " + g, 0).get().length ? n(this).clone().appendTo(s.node(":first > meta").get()) : (m = "Found duplicate meta node (" + g + ")!", console.error(m), f.push(m)) : (m = "Did not find form element with path: " + o + " and index: " + i + " so failed to load model.", console.error(m), f.push(m))
                }), g = s.node("*>meta>instanceID"), 1 !== g.get().length) return m = "InstanceID node in default instance error (found " + g.get().length + " instanceID nodes)", console.error(m), void f.push(m);
                if (1 !== s.node("*>meta>deprecatedID").get().length) {
                    var y = n.parseXML("<deprecatedID/>").documentElement;
                    document.adoptNode(y), n(y).appendTo(s.node("*>meta").get())
                }
                s.node("*>meta>deprecatedID").setVal(g.getVal()[0], null, "string"), g.setVal("", null, "string")
            }, h = function(e, t, i, r, o) {
                var a, l, u, d = "",
                    p = e.match(/jr:choice-name\(([^,]+),\s?'(.*?)'\)/);
                return p ? (a = s.evaluate(p[1], t, i, r, o), l = p[2].trim(), u = c.find('[name="' + l + '"]'), u.length > 0 && "select" === u.prop("nodeName").toLowerCase() ? d = u.find('[value="' + a + '"]').text() : u.length > 0 && "input" === u.prop("nodeName").toLowerCase() && (d = u.filter(function() {
                    return n(this).attr("value") === a
                }).siblings(".option-label.active").text()), e.replace(p[0], "'" + d + "'")) : e
                ...
                setBranchHandlers: function() {
                    var e = this;
                    c.on("showbranch hidebranch", function() {
                ...
                flipTo: function(e, t) {
                    var n = this;
                    this.$current.length > 0 && 1 === this.$current.closest("html").length ? this.$current[0] !== e && this.$current.addClass("fade-out").one("transitionend", function() {
                        n.$current.removeClass("current fade-out").parentsUntil(".or", ".or-group, .or-group-data, .or-repeat").removeClass("contains-current"), n.setToCurrent(e), n.focusOnFirstQuestion(e), n.toggleButtons(t)
                    }) : (this.setToCurrent(e), this.focusOnFirstQuestion(e), this.toggleButtons(t)), window.scrollTo && window.scrollTo(0, 0)
                },
                ...
                getIndex: function(e) {
                    var t, n, i, r;
                    return 1 !== e.length ? console.error("getIndex(): no input node provided or multiple") : (t = this.getInputType(e), n = this.getName(e), i = this.getWrapNodes(e), r = this.getWrapNodes("radio" === t && n !== e.attr("name") ? c.find('[data-name="' + n + '"]') : "fieldset" === t && e.hasClass("or-repeat") ? c.find('.or-repeat[name="' + n + '"]') : "fieldset" === t && e.hasClass("or-group") ? c.find('.or-group[name="' + n + '"]') : c.find('[name="' + n + '"]')), r.index(i))
                },
                ...
                setVal: function(e, t, n) {
                    var i, r, o;
                    return t = t || 0, "radio" == this.getInputType(c.find('[data-name="' + e + '"]').eq(0)) ? (o = this.getWrapNodes(c.find('[data-name="' + e + '"]')).eq(t).find('input[value="' + n + '"]'), void o.prop("checked", !0)) : (i = this.getWrapNodes(c.find('[name="' + e + '"]').eq(t)).find("input, select, textarea"), r = this.getInputType(i.eq(0)), "file" === r ? (i.eq(0).attr("data-loaded-file-name", n), !1) : (("date" === r || "datetime" === r) && (n = s.node().convert(n, r)), this.isMultiple(i.eq(0)) === !0 && (n = n.split(" ")), i.is("[readonly]") && i.toggleClass("has-value", !!n), void i.val(n)))
                }
            }, a.prototype.setAllVals = function() {
                var e, t, i, r = this;
                s.node(null, null, {
                    noEmpty: !0
                }).get().each(function() {
                    try {
                        i = n(this).text(), t = n(this).getXPath("instance"), e = s.node(t).get().index(n(this)), r.input.setVal(t, e, i)
                    } catch (o) {
                        console.error(o), f.push("Could not load input field value with name: " + t + " and value: " + i)
                    }
                })
            }, a.prototype.langs = {
                init: function() {
                    var e, t = this,
                        i = c.find("#form-languages").attr("data-default-lang"),
                ...
                setAll: function(e) {
                    var t = this;
                    n("#form-languages option").removeClass("active"), n(this).addClass("active"), c.find("[lang]").removeClass("active").filter('[lang="' + e + '"], [lang=""]').addClass("active"), c.find("select").each(function() {
                        t.setSelect(n(this))
                    }), c.find("legend span.active:not(.or-hint, .or-constraint-msg), label span.active:not(.or-hint, .or-constraint-msg)").each(function() {
                        0 === n(this).text().trim().length && n(this).text("[MISSING TRANSLATION]")
                    }), c.trigger("changelanguage")
                },
            ...
            }, a.prototype.editStatus = {
                set: function(e) {
                    c.attr("data-edited", Boolean(e)), c.trigger("edit", e)
                },
                get: function() {
                    return console.log("form element", c), "true" === c.attr("data-edited") ? !0 : !1
                }
            }, a.prototype.recordName = {
                set: function(e) {
                    c.attr("name", e)
                },
                get: function() {
            ...
            }, a.prototype.getNodesToUpdate = function(e, t, i) {
                var r, o = null,
                    a = [];
                return i = i || {}, t = t || "", this.$nonRepeats[e] || (this.$nonRepeats[e] = c.find(t + "[" + e + "]").closest(".calculation, .question, .note, .trigger").filter(function() {
                    return 0 === n(this).closest(".or-repeat").length
                })), "undefined" != typeof i.repeatPath && i.repeatIndex >= 0 && (o = c.find('.or-repeat[name="' + i.repeatPath + '"]').eq(i.repeatIndex)), r = o ? this.$nonRepeats[e].add(o) : c, i.nodes && 0 !== i.nodes.length ? i.nodes.forEach(function(n) {
                    a.push(t + "[" + e + '*="/' + n + ' "]'), a.push(t + "[" + e + '*="/' + n + ')"]'), a.push(t + "[" + e + '$="/' + n + '"]'), a.push(t + "[" + e + '*="/' + n + ']"]')
                }) : a = [t + "[" + e + "]"], r.find(a.join())
            }, a.prototype.branchUpdate = function(e) {
                function i(e, t, n) {
                    var i = s.evaluate(e, "boolean", t, n);
                    return i
                }
                ...
                function a(e) {
                    var n;
                    o(e) || (e.removeClass("disabled pre-init").trigger("showbranch"), t.enable(e), n = e.prop("nodeName").toLowerCase(), "label" == n ? e.children("input:not(.force-disabled), select, textarea").prop("disabled", !1) : (e.prop("disabled", !1), e.find('*:not(.or-branch) input[type="file"]:not(.force-disabled, [data-relevant])').prop("disabled", !0).prop("disabled", !1)))
                }
                ...
                function l(e) {
                    ...
                    (o(e) || r) && (e.addClass("disabled").trigger("hidebranch"), r ? e.removeClass("pre-init") : (e.clearInputs("change"), t.disable(e), e.find(".invalid-required, .invalid-constraint").find("input, select, textarea").each(function() {
                        x.setValid(n(this))
                    })), "label" == i ? e.children("input, select, textarea").prop("disabled", !0) : e.prop("disabled", !0))
                }
                var u, d, h, f, g, m, v, y, b = {},
                    w = [],
                    x = this,
                    _ = 0;
                v = this.getNodesToUpdate("data-relevant", "", e), y = p && c.find(".or-repeat.clone").length > 0 ? !0 : !1, v.each(function() {
                    if (-1 === n.inArray(n(this).attr("name"), w)) {
                        if (u = {}, m = null, u.relevant = n(this).attr("data-relevant"), u.path = x.input.getName(n(this)), d = n(this).closest(".or-branch"), 1 !== d.length) return void(0 === n(this).parents("#or-calculated-items").length && console.error("could not find branch node for ", n(this)));
                        f = y && d.closest(".or-repeat").length > 0 ? !0 : !1, g = y && d.closest(".or-repeat.clone").length > 0 ? !0 : !1, u.ind = g ? x.input.getIndex(n(this)) : 0, -1 === u.relevant.indexOf("..") && (m = f ? u.relevant + "__" + u.path.substring(0, u.path.lastIndexOf("/")) + "__" + u.ind : u.relevant), m && "undefined" != typeof b[m] ? h = b[m] : (h = i(u.relevant, u.path, u.ind), _++, b[m] = h), f || w.push(n(this).attr("name")), r(d, h)
                    }
                })
            }, a.prototype.itemsetUpdate = function(e) {
                var t, i, r, o, a = this,
                    l = {};
                o = this.getNodesToUpdate("data-items-path", ".itemset-template", e), t = p && c.find(".or-repeat.clone").length > 0 ? !0 : !1, o.each(function() {
                    var e, o, u, c, d, p, h = n(this),
                        f = {},
                        g = h.data(),
                        m = n(this).prop("nodeName").toLowerCase(),
                        v = "label" === m ? n(this).children("input").eq(0) : n(this).parent("select"),
                        y = h.closest("label, select").siblings(".itemset-labels"),
                        b = h.attr("data-items-path"),
                        w = y.attr("data-label-type"),
                        x = y.attr("data-label-ref"),
                        _ = y.attr("data-value-ref");
                    if (p = a.input.getName(v), i = t && v.closest(".or-repeat").length > 0 ? !0 : !1, r = t && v.closest(".or-repeat.clone").length > 0 ? !0 : !1, d = r ? a.input.getIndex(v) : 0, "undefined" != typeof l[b]) c = l[b];
                    else {
                        var k = !0;
                        c = n(s.evaluate(b, "nodes", p, d, k)), i || (l[b] = c)
                    }
                    f.length = c.length, f.text = c.text(), (f.length !== g.length || f.text !== g.text) && (h.data(f), n(this).closest(".question").clearInputs("change").find(m).not(h).remove(), n(this).parent("select").siblings(".or-option-translations").empty(), c.each(function() {
                        e = n("<root/>"), h.clone().appendTo(e).removeClass("itemset-template").addClass("itemset").removeAttr("data-items-path"), o = "itext" === w ? y.find('[data-itext-id="' + n(this).children(x).text() + '"]').clone() : n('<span class="active" lang="">' + n(this).children(x).text() + "</span>"), u = n(this).children(_).text(), e.find("[value]").attr("value", u), "label" === m ? (e.find("input").after(o), y.before(e.find(":first"))) : "option" === m && (1 === o.length && e.find("option").text(o.text()), o.attr("data-option-value", u).attr("data-itext-id", "").appendTo(y.siblings(".or-option-translations")), h.siblings().addBack().last().after(e.find(":first")))
                    }), "select" === v.prop("nodeName").toLowerCase() && (a.langs.setSelect(v), v.trigger("changeoption")))
                })
            }, a.prototype.outputUpdate = function(e) {
                var t, i, r, o, a, l, u, d, h = {},
                    f = "",
                    g = this;
                d = this.getNodesToUpdate("data-value", ".or-output", e), i = p && c.find(".or-repeat.clone").length > 0 ? !0 : !1, d.each(function() {
                    t = n(this).attr("data-value"), a = 1 === n(this).parent("span").parent("label").find("[name]").eq(0).length ? n(this).parent().parent().find("[name]").eq(0) : 1 === n(this).parent("span").parent("legend").parent("fieldset").find("[name]").eq(0).length ? n(this).parent().parent().parent().find("[name]").eq(0) : n(this).closest("[name]"), l = g.input.getName(a), r = i && n(this).closest(".or-repeat").length > 0, o = i && n(this).closest(".or-repeat.clone").length > 0, u = o ? g.input.getIndex(a) : 0, "undefined" != typeof h[t] ? f = h[t] : (f = s.evaluate(t, "string", l, u), r || (h[t] = f)), n(this).text !== f && n(this).text(f)
                })
            }, a.prototype.grosslyViolateStandardComplianceByIgnoringCertainCalcs = function() {
                var e = c.find('[name$="/meta/instanceID"][data-calculate]');
                e.length > 0 && e.removeAttr("data-calculate")
            }, a.prototype.calcUpdate = function(e) {
                var t, i = this;
                e = e || {}, t = this.getNodesToUpdate("data-calculate", "", e), t = t.add(this.getNodesToUpdate("data-relevant", "[data-calculate]", e)), t.each(function() {
                    var t, r, o, a, l, u = n(this),
                        c = u.attr("name"),
                        d = -1 !== c.lastIndexOf("/") ? c.substring(c.lastIndexOf("/") + 1) : c,
                        p = u.attr("data-calculate"),
                        f = u.attr("data-type-xml"),
                        g = u.attr("data-constraint"),
                        m = u.attr("data-relevant"),
                        v = m ? s.evaluate(m, "boolean", c) : !0;
                    if (o = s.node(c).get(), o.length > 1 && e.repeatPath && -1 !== c.indexOf(e.repeatPath)) a = s.node(e.repeatPath, e.repeatIndex).get().find(d), l = o.index(a);
                    else {
                    ...
                    p = h(p, "string", c, l), t = v && p ? s.evaluate(p, "string", c, l) : "", r = s.node(c, l).setVal(t, g, f), i.input.setVal(c, l, t)
                })
            }, a.prototype.bootstrapify = function() {
                c.addClass("clearfix").find("label, legend").each(function() {
                    var e = n(this);
                ...
                }), c.find(".or-constraint-msg").each(function() {
                ...
                }), c.find(".or-appearance-horizontal .option-wrapper").each(function() {
                    var e = n(this),
                        t = e.find("label");
                    t.length % 3 === 2 && e.append('<label class="filler"></label>')
                })
            }, a.prototype.preloads = {
                init: function(e) {
                    var t, i, r, o, a, l, u, d, p, h = this;
                    c.find("#or-preload-items input").each(function() {
                        d = e.input.getProps(n(this)), t = n(this).attr("data-preload").toLowerCase(), i = n(this).attr("data-preload-params").toLowerCase(), "undefined" != typeof h[t] ? (u = s.node(d.path, d.index), o = u.getVal()[0], a = h[t]({
                            param: i,
                            curVal: o,
                            dataNode: u
                        }), u.setVal(a, null, d.xmlType)) : console.error('Preload "' + t + '"" not supported. May or may not be a big deal.')
                    }), l = s.node("*>meta>*"), l.get().each(function() {
                        if (t = null, r = n(this).prop("nodeName"), u = s.node("*>meta>" + r), o = u.getVal()[0], 0 === c.find('#or-preload-items input[name$="/meta/' + r + '"][data-preload]').length) switch (r) {
                            case "instanceID":
                                t = "instance", p = "string", i = "";
                                break;
                            case "timeStart":
                                t = "timestamp", p = "datetime", i = "start";
                                break;
                            case "timeEnd":
                                t = "timestamp", p = "datetime", i = "end"
                        }
                        t && u.setVal(h[t]({
                            param: i,
                            curVal: o,
                ...
                timestamp: function(e) {
                    var t;
                    return "start" == e.param ? e.curVal.length > 0 ? e.curVal : s.evaluate("now()", "string") : "end" == e.param ? (c.on("beforesave", function() {
                        t = s.evaluate("now()", "string"), e.dataNode.setVal(t, null, "datetime")
                    }), s.evaluate("now()", "string")) : "error - unknown timestamp parameter"
                },
                date: function(e) {
                    var t, n, i, r;
                    return 0 === e.curVal.length ? (t = new Date(s.evaluate("today()", "string")), n = t.getFullYear().toString().pad(4), i = (t.getMonth() + 1).toString().pad(2), r = t.getDate().toString().pad(2), n + "-" + i + "-" + r) : e.curVal
                },
                property: function(e) {
                    return 0 === e.curVal.length ? "no device properties in enketo" : e.curVal
                },
                context: function(e) {
                ...
                instance: function(e) {
                    var t = e.curVal.length > 0 ? e.curVal : s.evaluate("concat('uuid:', uuid())", "string");
                    return c.data({
                        instanceID: t
                    }), t
                }
                ...
                init: function(e) {
                    var t, i, r, o, a, l, u, d, p, h = this;
                    this.formO = e, c.find(".or-repeat").prepend('<span class="repeat-number"></span>'), c.find(".or-repeat:not([data-repeat-fixed])").append('<div class="repeat-buttons"><button type="button" class="btn btn-default repeat"><i class="glyphicon glyphicon-plus"> </i></button><button type="button" disabled class="btn btn-default remove"><i class="glyphicon glyphicon-minus"> </i></button></div>'), c.on("click", "button.repeat:enabled", function() {
                        return h.clone(n(this).closest(".or-repeat")), !1
                    }), c.on("click", "button.remove:enabled", function() {
                        return h.remove(n(this).closest(".or-repeat.clone")), !1
                    }), l = function(e) {
                        for (u++, r = e.attr("data-repeat-count") || "", i = r.length > 0 ? parseInt(s.node(r).getVal()[0], 10) : 0, p = c.find('.or-repeat[name="' + e.attr("name") + '"]').index(e), d = s.node(e.attr("name"), p).get(), o = d.siblings(d.prop("nodeName") + ":not([template])").addBack().length, a = i > o ? i : o, t = 1; a > t; t++) h.clone(e.siblings().addBack().last(), !1);
                        e.siblings(".or-repeat").addBack().find(".or-repeat").filter(function() {
                            return n(this).parents(".or-repeat").length === u
                        }).each(function() {
                            l(n(this))
                        })
                    }, c.find(".or-repeat").filter(function() {
                ...
                clone: function(e, i) {
                    var r, o, a, l, u, d, p, h, f, g = this;
                    if (f = i === !1 ? 0 : 400, 1 !== e.length) return console.error("Nothing to clone"), !1;
                    for (a = e.parent(".or-group"), r = a.children(".or-repeat:not(.clone)").eq(0), o = r.clone(!0, !0), o.addClass("clone").find(".clone").remove(), o.find(".invalid-required, .invalid-constraint").find("input, select, textarea").each(function() {
                        g.formO.setValid(n(this))
                    }), o.insertAfter(e).parent(".or-group").numberRepeats(), o.clearInputs(""), t.destroy(o), t.init(o), l = c.find('.or-repeat[name="' + e.attr("name") + '"]').index(e), u = [], o.find('input[type="radio"]').each(function() {
                        -1 === n.inArray(n(this).attr("data-name"), u) && u.push(n(this).attr("data-name"))
                    }), d = 0; d < u.length; d++) h = (new Date).getTime().toString() + "_" + Math.floor(1e4 * Math.random() + 1), o.find('input[type="radio"][data-name="' + u[d] + '"]').attr("name", h);
                    return this.toggleButtons(r.parent()), p = r.attr("name"), p.length > 0 && l >= 0 && s.cloneTemplate(p, l), o.trigger("addrepeat", l + 1), !0
                },
                remove: function(e) {
                    var t = 600,
                        n = this,
                        i = e.prev(".or-repeat"),
                        r = e.attr("name"),
                        o = c.find('.or-repeat[name="' + r + '"]').index(e),
                        a = e.parent(".or-group");
                    e.hide(t, function() {
                        e.remove(), a.numberRepeats(), n.toggleButtons(a), i.trigger("removerepeat"), s.node(r, o).remove()
                    })
                },
                toggleButtons: function(e) {
                    e = "undefined" != typeof e && 0 !== e.length && e ? e : e = c, e.find("button.repeat, button.remove").prop("disabled", !0), e.find(".or-repeat:last-child > .repeat-buttons button.repeat").prop("disabled", !1), e.find("button.remove").not(":eq(0)").prop("disabled", !1)
                }
            }, a.prototype.setEventHandlers = function() {
                var e = this;
                c.attr("onsubmit", "return false;"), c.on("blur", 'input:not([type="text"], [type="radio"], [type="checkbox"])', function() {
                    "undefined" != typeof n(this).prop("validity").badInput && n(this).prop("validity").badInput && n(this).val("")
                }), c.on("change.file validate", "input:not(.ignore), select:not(.ignore), textarea:not(.ignore)", function(t) {
                ...
                }), c.on("focus fakefocus", "input:not(.ignore), select:not(.ignore), textarea:not(.ignore)", function(t) {
                    e.progress.update(t.target)
                }), c.on("focus blur fakefocus fakeblur", "input:not(.ignore), select:not(.ignore), textarea:not(.ignore)", function(t) {
                ...
                }), s.$.on("dataupdate", function(t, n) {
                    e.calcUpdate(n), e.branchUpdate(n), e.outputUpdate(n), e.itemsetUpdate(n)
                }), c.on("change addrepeat removerepeat", function() {
                    e.editStatus.set(!0)
                }), c.on("addrepeat", function(t, i) {
                    var r = n(t.target);
                    e.setAllVals(r), e.calcUpdate({
                        repeatPath: r.attr("name"),
                        repeatIndex: i
                    })
                }), c.on("changelanguage", function() {
                    e.outputUpdate()
                })
            }, a.prototype.setValid = function(e, t) {
                var n = t ? "invalid-" + t : "invalid-constraint invalid-required";
                this.input.getWrapNodes(e).removeClass(n)
            }, a.prototype.setInvalid = function(e, t) {
                t = t || "constraint", this.input.getWrapNodes(e).addClass("invalid-" + t).find(".required-subtle").attr("style", "color: transparent;")
            }, a.prototype.validateAll = function() {
                var e, t = this;
                return c.find("fieldset:disabled input, fieldset:disabled select, fieldset:disabled textarea, input:disabled, select:disabled, textarea:disabled").each(function() {
                    t.setValid(n(this))
                }), c.find("input, select, textarea").not(".ignore").trigger("validate"), e = c.find(".invalid-required, .invalid-constraint").eq(0), e.length > 0 && window.scrollTo && (this.pages.active && this.pages.flipToPageContaining(e), window.scrollTo(0, e.offset().top - 50)), 0 === e.length
            }, a.prototype.progress = {
                status: 0,
                lastChanged: null,
                update: function(e) {
                    var t, i = c.find(".question").not(".disabled").filter(function() {
                        return 0 === n(this).closest(".disabled").length
                    });
                    this.lastChanged = e || this.lastChanged, t = Math.round(100 * (i.index(n(this.lastChanged).closest(".question")) + 1) / i.length), t !== this.status && (this.status = t, c.trigger("progressupdate", t))
                },
                get: function() {
                    return this.status
                }
            }, a.prototype.isValid = function() {
                return c.find(".invalid-required, .invalid-constraint").length > 0 ? !1 : !0
            }, a.prototype.addPageBreaks = function() {}
        }
        return i
        ...
        return {
            ...
            save: function(e, t) {
                "object" != typeof e && (e = JSON.parse(e)), "object" != typeof t && (t = JSON.parse(t)), e = p(e, t);
            ...
            createOrUpdateEntity: function(e, t) {
                "object" != typeof e && (e = JSON.parse(e)), "object" != typeof t && (t = JSON.parse(t)), e = p(e, t), r.route(e.instanceId)
            },
...
define("mockInstances", function(e) {
        ...
        function t(t) {
            ...
            var s = ["id"];
            this.toXML = function() {
                var n, i, l, u, c, d, p, h, f, g, m = e(e.parseXML("<root />"));
                ...
                if (t.form.sub_forms)
                    for (n = 0; n < t.form.sub_forms.length; n++)
                        if (p = t.form.sub_forms[n], f = o(p.default_bind_path), g = f.match(/.*\/([^\/]*)\/$/)[1], p.bind_type)
                            for (i = 0; i < p.instances.length; i++)
                                for (h = p.instances[i], l = 0; l < p.fields.length; l++) u = p.fields[l], "undefined" != typeof h[u.name] && -1 == s.indexOf(u.name) && (c = "undefined" == typeof u.bind ? f + u.name : u.bind, d = h[u.name], r(m, c, d, {
                                    name: g,
                                    index: i
                                }), console.log("added path: " + c + ' with value: "' + d + '", repeat NodeName: ' + g + " and repeat index: " + i));
                        else a("Repeat (subform) is missing bind_type.");
                if (m.find("instance>*:first")[0] == undefined) {
                    return "";
                }
                ...
                return d.each(function() {
                    var r, d, p, h, f, g = [],
                        m = {},
                        v = e(this);
                    if (p = "/model/instance" + v.getXPath(), t.form.sub_forms && (g = e.grep(t.form.sub_forms, function(e) {
                        return e.default_bind_path === p || e.default_bind_path === p + "/"
                    })), 0 === g.length) a('Repeat definition not found (no subform with default_bind_path: "' + p + '" in JSON format)');
                    else if (g.length > 1) a('Multiple repeat definititions found (multiple subforms with default_bind_path: "' + p + '" in JSON format)');
                    else
                        for (h = g[0], -1 === e.inArray(p, u) && (u.push(p), l = jQuery.extend(!0, {}, h.instances), h.instances = []), o = v.find("*").filter(function() {
                            return 0 === e(this).children().length
                        }), c = c.takeOut(o), o.each(function() {
                            var t = i(e(this)),
                                r = n(t.path, h.fields, h.default_bind_path);
                            r && (m[r.name] = t.value)
                        }), h.instances.push(m), f = h.instances.indexOf(m), r = 0; r < s.length; r++) d = s[r], l[f] && "undefined" != typeof l[f][d] && (m[d] = l[f][d])
                }), c.each(function() {
                    var r = i(e(this)),
        ...
        var s, l, u, c, d, p, h, f = r.getAllQueryParams(),
            g = new t(f);
        return window.onerror = function(e, t, n) {
            return console.error("Javascript Error: , msg: {0}, url: {1}, line: {2}".format(e, t, n)), !0
        }, a("form.or").replaceWith(o.getForm()), (l = g.get()) ? (s = o.getModel(), d = new n(l), u = d.toXML(), p = new e("form.or:eq(0)", s, u), c = p.init(), console.log("load errors", c), void a(document).on("click", "button#submit-form:not(:disabled)", function() {
            var e, t, n = a(this);
            a(this).btnBusyState(!0), setTimeout(function() {
                if ("undefined" != typeof p) {
                    if (!p.validate()) return i.alert("Form contains errors <br/>(please see fields marked in red)"), void n.btnBusyState(!1);
                    e = d.get(p), delete e.errors, t = g.save(p.getInstanceID(), e), n.btnBusyState(!1)
                }
            }, 100)
        })) : (a("form.or").remove(), h = f.instanceId || void 0, i.alert('JSON Instance with id "' + h + '" could not be found.'))
    ...
    }), window._mapsLoaded = $.Deferred(), window.gmapsLoaded = function() {
        delete window.gmapsLoaded, _mapsLoaded.resolve()
    }, define("enketo-widget/geopoint/gmapsDone", ["Modernizr", "text!enketo-config"], function(e, t) {
        var n, i, r = "";
        return e.touch || (i = JSON.parse(t), n = i.gmapsDynamicApiKey ? "&key=" + i.gmapsDynamicApiKey : "", r = "https://maps.google.com/maps/api/js?v=3.exp" + n + "&sensor=false&libraries=places&callback=gmapsLoaded", require([r])), window._mapsLoaded.done
    }), define("enketo-widget/geopoint/geopointpicker", ["jquery", "enketo-js/Widget", "text!enketo-config"], function(e, t, n) {
        function i(e, n) {
            var i = this;
            this.namespace = s, t.call(this, e, n), r ? this._init() : (o.done(function() {
                i._init()
            }), a || (require(["enketo-widget/geopoint/gmapsDone"], function(e) {
                r = e, o.resolve()
            }), a = !0))
        }
        var r, o = e.Deferred(),
            ...
            s = "geopointpicker",
            l = JSON.parse(n);
        i.prototype = Object.create(t.prototype), i.prototype.constructor = i, i.prototype._init = function() {
            var t, n = this;
            this._addDomElements(), t = this.$inputOrigin.val().split(" "), this._updateMapFn = "_updateDynamicMap", this.$widget.find('input:not([name="search"])').on("change change.bymap change.bysearch", function(e) {
                var t = "" !== n.$lat.val() ? n.$lat.val() : 0,
                    i = "" !== n.$lng.val() ? n.$lng.val() : 0,
                    r = "" !== n.$alt.val() ? n.$alt.val() : 0,
                    o = n.$acc.val(),
                    a = 0 === t && 0 === i ? "" : t + " " + i + " " + r + " " + o;
                e.stopImmediatePropagation(), n.$inputOrigin.val(a).trigger("change"), "bymap" !== e.namespace && "bysearch" !== e.namespace && n._updateMap(t, i), "bysearch" !== e.namespace && this.$search && n.$search.val("")
            }), this.$widget.on("focus blur", "input", function(e) {
                n.$inputOrigin.trigger(e.type)
            }), t[3] && this.$acc.val(t[3]), t[2] && this.$alt.val(t[2]), t[1] && this.$lng.val(t[1]), t[0].length > 0 && this.$lat.val(t[0]).trigger("change"), this.$detect && this._enableDetection(), this.options.touch ? this.$map && (this._updateMapFn = "_updateStaticMap", this._updateMap(0, 0, 1), e(window).on("resize", function() {
                var t = e(window).data("resizecount") || 0;
                t++, e(window).data("resizecount", t), window.setTimeout(function() {
                    t == e(window).data("resizecount") && (e(window).data("resizecount", 0), n._updateMap())
                }, 500)
            })) : r(function() {
                n._dynamicMapAvailable() && (n._updateMap(0, 0, 1), n.$search && n._enableSearch())
            })
        }, i.prototype._addDomElements = function() {
            var t = '<button name="geodetect" type="button" class="btn btn-default" title="detect current location" data-placement="top"><i class="glyphicon glyphicon-screenshot"> </i></button>',
                n = '<div class="input-group"><input class="geo ignore form-control" name="search" type="text" placeholder="search for place or address" disabled="disabled"/><span class="input-group-btn"><button class="btn btn-default"><i class="glyphicon glyphicon-search"> </i></button></span></div>',
                i = '<div class="map-canvas-wrapper"><div class="map-canvas"></div></div>';
            this.$inputOrigin = e(this.element), this.$form = this.$inputOrigin.closest("form"), this.$widget = e('<div class="geopoint widget"><div class="search-bar no-search-input no-map"></div><div class="geo-inputs"><label class="geo">latitude (x.y &deg;)<input class="ignore" name="lat" type="number" step="0.0001" /></label><label class="geo">longitude (x.y &deg;)<input class="ignore" name="long" type="number" step="0.0001" /></label><label class="geo">altitude (m)<input class="ignore" name="alt" type="number" step="0.1" /></label><label class="geo">accuracy (m)<input class="ignore" name="acc" type="number" step="0.1" /></label></div></div>'), navigator.geolocation && (this.$widget.find(".search-bar").append(t), this.$detect = this.$widget.find('button[name="geodetect"]')), this.options.touch !== !0 && (this.$widget.find(".search-bar").removeClass("no-search-input").append(n), this.$search = this.$widget.find('[name="search"]')), (this.options.touch !== !0 || this.options.touch === !0 && this.$inputOrigin.parents(".or-appearance-maps").length > 0) && (this.$widget.find(".search-bar").removeClass("no-map").after(i), this.$map = this.$widget.find(".map-canvas")), this.$lat = this.$widget.find('[name="lat"]'), this.$lng = this.$widget.find('[name="long"]'), this.$alt = this.$widget.find('[name="alt"]'), this.$acc = this.$widget.find('[name="acc"]'), this.$inputOrigin.hide().after(this.$widget).parent().addClass("clearfix")
        }, i.prototype._enableDetection = function() {
            var e = this;
            this.$detect.click(function(t) {
                return t.preventDefault(), navigator.geolocation.getCurrentPosition(function(t) {
                    e._updateMap(t.coords.latitude, t.coords.longitude), e._updateInputs(t.coords.latitude, t.coords.longitude, t.coords.altitude, t.coords.accuracy)
                }), !1
            })
        }, i.prototype._enableSearch = function() {
            var t = new google.maps.Geocoder,
                n = this;
            this.$search.prop("disabled", !1), this.$search.on("change", function(i) {
                i.stopImmediatePropagation();
                var r = e(this).val();
                return "undefined" != typeof t && t.geocode({
                    address: r,
                    bounds: n.map.getBounds()
                }, function(e, t) {
                    if (t == google.maps.GeocoderStatus.OK) {
                        n.$search.attr("placeholder", "search");
                        var i = e[0].geometry.location;
                        n._updateMap(i.lat(), i.lng()), n._updateInputs(i.lat(), i.lng(), null, null, "change.bysearch")
                    } else n.$search.val(""), n.$search.attr("placeholder", r + " not found, try something else.")
                }), !1
            })
        }, i.prototype._dynamicMapAvailable = function() {
            return this.$map && "undefined" != typeof google && "undefined" != typeof google.maps
        }, i.prototype._updateMap = function(e, t, n) {
            return this.$map ? (e = e || Number(this.$lat.val()), t = t || Number(this.$lng.val()), n = n || 15, 0 === e && 0 === t && (n = 1), this[this._updateMapFn](e, t, n)) : void 0
        }, i.prototype._updateStaticMap = function(e, t, n) {
            var i, r = Math.round(this.$map.width()),
                o = Math.round(this.$map.height()),
                a = l.gmapsStaticApiKey ? "&key=" + l.gmapsStaticApiKey : "";
            i = "center=" + e + "," + t + "&size=" + r + "x" + o + "&zoom=" + n + "&sensor=false" + a, this.$map.empty().append('<img src="https://maps.googleapis.com/maps/api/staticmap?' + i + '"/>')
        }, i.prototype._updateDynamicMap = function(e, t, n) {
            var i = (this.$map, this);
            if (this._dynamicMapAvailable() && "undefined" != typeof google.maps.LatLng) {
                var r = {
                    zoom: n,
                ...
                this.map = new google.maps.Map(this.$map[0], r), this._placeMarker(), google.maps.event.addListener(this.map, "click", function(e) {
                    i._updateInputs(e.latLng.lat(), e.latLng.lng(), "", "", "change.bymap"), i._placeMarker(e.latLng)
                })
            }
        }, i.prototype._placeMarker = function(e) {
            var t;
            e = e || this.map.getCenter(), "undefined" != typeof this.marker && this.marker.setMap(null), this.marker = new google.maps.Marker({
                position: e,
                map: this.map,
                draggable: !0
            }), t = this, this.options.touch || (google.maps.event.addListener(this.marker, "dragend", function() {
                t._updateInputs(t.marker.getPosition().lat(), t.marker.getPosition().lng(), "", "", "change.bymap"), t._centralizeWithDelay()
            }), this._centralizeWithDelay(5e3)), this._centralizeWithDelay(0)
        }, i.prototype._centralizeWithDelay = function(e) {
            var t = this;
            window.setTimeout(function() {
                t.map.panTo(t.marker.getPosition())
            }, e)
        }, i.prototype._updateInputs = function(e, t, n, i, r) {
            n = n || "", i = i || "", r = r || "change", this.$lat.val(Math.round(1e4 * e) / 1e4), this.$lng.val(Math.round(1e4 * t) / 1e4), this.$alt.val(Math.round(10 * n) / 10), this.$acc.val(Math.round(10 * i) / 10).trigger(r)
        }, e.fn[s] = function(t, n) {
            return this.each(function() {
                var r = e(this),
                    o = e(this).data(s);
                t = t || {}, o || "object" != typeof t ? o && "string" == typeof t && o[t](this) : r.data(s, o = new i(this, t, n))
            })
        }
        ...
        n.prototype = Object.create(e.prototype), n.prototype.constructor = n, n.prototype._init = function() {
            ...
            var o = t(this),
                a = o.data(i);
            return e = e || {}, a || "object" != typeof e ? a && "string" == typeof e && a[e](this) : o.data(i, a = new n(o[0], e, r)), this
        }
    }),
    function(e, t, n) {
        var i = function(t, n) {
            ...
            place: function() {
                if (!this.isInline) {
                    var n = this.$widget.outerWidth(),
                        ...
                        p = u.left,
                        h = u.top;
                    this.$widget.removeClass("timepicker-orient-top timepicker-orient-bottom timepicker-orient-right timepicker-orient-left"), "auto" !== this.orientation.x ? (this.picker.addClass("datepicker-orient-" + this.orientation.x), "right" === this.orientation.x && (p -= n - d)) : (this.$widget.addClass("timepicker-orient-left"), u.left < 0 ? p -= u.left - r : u.left + n > o && (p = o - n - r));
                    var f, g, m = this.orientation.y;
                    "auto" === m && (f = -s + u.top - i, g = s + a - (u.top + c + i), m = Math.max(f, g) === g ? "top" : "bottom"), this.$widget.addClass("timepicker-orient-" + m), "top" === m ? h += c : h -= i + parseInt(this.$widget.css("padding-top"), 10), this.$widget.css({
                        top: h,
                        left: p,
                        zIndex: l
                    })
        ...
        u.prototype = {
            ...
            _process_options: function(t) {
                ...
                var n = this.o = e.extend({}, this._o),
                    i = n.language;
                switch (f[i] || (i = i.split("-")[0], f[i] || (i = p.language)), n.language = i, n.startView) {
                    case 2:
                    case "decade":
                        n.startView = 2;
                        break;
            ...
            place: function() {
                if (!this.isInline) {
                    var t = this.picker.outerWidth(),
                        ...
                        p = u.left,
                        h = u.top;
                    this.picker.removeClass("datepicker-orient-top datepicker-orient-bottom datepicker-orient-right datepicker-orient-left"), "auto" !== this.o.orientation.x ? (this.picker.addClass("datepicker-orient-" + this.o.orientation.x), "right" === this.o.orientation.x && (p -= t - d)) : (this.picker.addClass("datepicker-orient-left"), u.left < 0 ? p -= u.left - i : u.left + t > r && (p = r - t - i));
                    var f, g, m = this.o.orientation.y;
                    "auto" === m && (f = -a + u.top - n, g = a + o - (u.top + c + n), m = Math.max(f, g) === g ? "top" : "bottom"), this.picker.addClass("datepicker-orient-" + m), "top" === m ? h += c : h -= n + parseInt(this.picker.css("padding-top")), this.picker.css({
                        top: h,
                        left: p,
                        zIndex: l
                    })
            ...
            fill: function() {
                ...
                d.setUTCDate(p), d.setUTCDate(p - (d.getUTCDay() - this.o.weekStart + 7) % 7);
                var h = new Date(d);
                h.setUTCDate(h.getUTCDate() + 42), h = h.valueOf();
                for (var m, v = []; d.valueOf() < h;) {
                    ...
                    if (m = this.getClassNames(d), m.push("day"), this.o.beforeShowDay !== e.noop) {
                        ...
                        _ === t ? _ = {} : "boolean" == typeof _ ? _ = {
                            ...
                            classes: _
                        }), _.enabled === !1 && m.push("disabled"), _.classes && (m = m.concat(_.classes.split(/\s+/))), _.tooltip && (i = _.tooltip)
                    }
                ...
                }), (s > o || o > u) && k.addClass("disabled"), o == s && k.slice(0, l).addClass("disabled"), o == u && k.slice(c + 1).addClass("disabled"), v = "", o = 10 * parseInt(o / 10, 10);
                var T = this.picker.find(".datepicker-years").find("th:eq(1)").text(o + "-" + (o + 9)).end().find("td");
                o -= 1;
                for (var E, D = e.map(this.dates, function(e) {
                    return e.getUTCFullYear()
                }), C = -1; 11 > C; C++) E = ["year"], -1 === C ? E.push("old") : 10 === C && E.push("new"), -1 !== e.inArray(o, D) && E.push("active"), (s > o || o > u) && E.push("disabled"), v += '<span class="' + E.join(" ") + '">' + o + "</span>", o += 1;
                T.html(v)
            },
        ...
        var f = e.fn.datepicker.dates = {
            ...
            g = {
                ...
                parseDate: function(i, r, o) {
                    ...
                    var p, h, a, c = i && i.match(this.nonpunctuation) || [],
                        i = new Date,
                        m = {},
                    ...
                    if (c.length != b.length && (b = e(b).filter(function(t, n) {
                        ...
                        for (var d = 0, w = b.length; w > d; d++) {
                            if (p = parseInt(c[d], 10), a = b[d], isNaN(p)) switch (a) {
                                case "MM":
                                    h = e(f[o].months).filter(function() {
                                        var e = this.slice(0, c[d].length),
                                            t = c[d].slice(0, e.length);
                                        return e == t
                                    }), p = e.inArray(h[0], f[o].months) + 1;
                                    break;
                                case "M":
                                    h = e(f[o].monthsShort).filter(function() {
                                        var e = this.slice(0, c[d].length),
                                            t = c[d].slice(0, e.length);
                                        return e == t
                                    }), p = e.inArray(h[0], f[o].monthsShort) + 1
                            }
                            m[a] = p
                        }
                        for (var x, _, d = 0; d < v.length; d++) _ = v[d], _ in m && !isNaN(m[_]) && (x = new Date(i), y[_](x, m[_]), isNaN(x) || (i = x))
                    }
                    return i
                },
    ...
    }), define("text!enketo-widget/geopoint/config.json", [], function() {
