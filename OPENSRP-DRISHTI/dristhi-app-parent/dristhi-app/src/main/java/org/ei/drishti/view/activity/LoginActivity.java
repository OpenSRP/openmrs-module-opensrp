...
public class LoginActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setActionHandlerOnSettingsField();
    ...
    private void setActionHandlerOnSettingsField() {
    	final LoginActivity ac = this;
        settingsTv.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View v) {
				 startActivity(new Intent(ac, SettingsActivity.class));
			}
		});
    }
    ...
    private void goToHome() {
        startActivity(new Intent(this, CRVSHomeActivity.class));
        finish();
    }
